...
* Per Look, Feel e UX
   * Modificare il modello JS, i CSS e [estendere/ignorare Javascript](client-customize.md#extending-javascript)
...
* Aggiunta di una nuova operazione personalizzata
   ...
   * Utilizza [OperationServices](server-customize.md#operationservice-class) esistente come necessario
...
1. Richiama la fabbrica e riceve una `SocialComponent`in grado di gestire la risorsa e la richiesta.
