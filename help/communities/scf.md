...
Una delle modifiche più evidenti nel nuovo framework è l&#39;utilizzo del [Handlebars JS](https://handlebarsjs.com/) linguaggio HBS, una popolare tecnologia open-source per il rendering server-client.
