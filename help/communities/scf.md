...
* **Estensibile**: L’implementazione dei componenti è orientata agli oggetti e si basa sulla logica di business: facile da aggiungere all’accesso incrementale alle attività aziendali sul server
...
* Per look, Feel e UX
   * Modificare il modello JS, i CSS e [estendere/sostituire Javascript](client-customize.md#extending-javascript)
...
* Aggiunta di una nuova operazione personalizzata
   * Crea una nuova [operazione post Sling](server-customize.md#postoperation-class)
...
* [Funzionalità di base SRP e UGC](srp-and-ugc.md)  - Metodi di utilità e esempi dell’API SRP
* [Accesso all’UGC con SRP](accessing-ugc-with-srp.md)  - Linee guida per la codifica
