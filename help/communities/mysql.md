...
* Installazione di [MySQL Server](https://dev.mysql.com/downloads/mysql/) Community Server versione 5.6
...
* Installazione di [MySQL workbench](https://dev.mysql.com/downloads/tools/workbench/)
...
* La `Connection Name` scelta viene immessa come nome `datasource` nella [configurazione JDBC OSGi](#configure-jdbc-connections)
...
Una volta eseguiti gli script, è necessario aggiornare la sezione `SCHEMAS`della `Navigator` per visualizzare il nuovo database. Utilizzate l&#39;icona di aggiornamento a destra di &#39;SCHEMAS&#39;:
...
* Per ogni istanza AEM pubblicazione
* Accesso con privilegi di amministratore
* Accedere alla [console Web](../../help/sites-deploying/configuring-osgi.md)
