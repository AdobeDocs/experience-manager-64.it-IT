...
Per includere l&#39;accesso social, è *obbligatorio *per creare applicazioni personalizzate Facebook e Twitter.
...
1. Dalla navigazione globale, seleziona **[!UICONTROL Strumenti > Cloud Services > Configurazione dell&#39;accesso a Facebook Social]**.
...
1. Vai a **[!UICONTROL Strumenti > Generale > Browser di configurazione]**. Seleziona il tuo contesto e modifica le proprietà. Abilita le configurazioni cloud se non ancora abilitate.
...
1. Seleziona l’icona a forma di matita da aprire per la modifica.
   ...
   * **[!UICONTROL Aggiorna]**
utenteSe questa opzione è selezionata, aggiorna i dati utente nella directory archivio su ogni accesso per riflettere le modifiche di profilo o i dati aggiuntivi richiesti. Il valore predefinito è deselezionato.
...
1. Dalla navigazione globale, seleziona **[!UICONTROL Strumenti > Cloud Services > Configurazione dell&#39;accesso a Twitter Social]**.
...
1. Creare/modificare la configurazione del servizio cloud Twitter.
   ...
   * **[!UICONTROL Titolo]**  (*obbligatorio*) Immetti un titolo di visualizzazione che identifichi l’app Twitter. Si consiglia di utilizzare lo stesso nome immesso come *Nome visualizzato* per l&#39;app Twitter.

   * **[!UICONTROL Chiave consumatore]**  (*obbligatoria*) Immetti la chiave  **consumer (API)** per l’app Twitter. Questo identifica l&#39;istanza [Adobe Granite OAuth Application e Provider](https://helpx.adobe.com/experience-manager/6-3/communities/using/social-login.html#AdobeGraniteOAuthApplicationandProvider) creata dalla finestra di dialogo.

   * **[!UICONTROL Segreto consumatore]** (*obbligatorio*) Inserisci il  ***segretario del consumatore(API)*** per l’app Twitter.

   * **[!UICONTROL Crea]** utentiSe questa opzione è selezionata, l&#39;accesso con un account Twitter creerà una voce utente AEM e la aggiungerà come membro al gruppo o ai gruppi di utenti selezionati. Il valore predefinito è selezionato (fortemente consigliato).
...
1. Modifica le proprietà del nodo ntBaseLucene-oauth:
   ...
   * **[!UICONTROL nome]**: oauthid-123xxxx
...
**&amp;ast;** Per il  **** nameoauthid-*123*, sostituisci  *123* con l’ ***App*** IDo la  ***chiave Twitter*** Consumer (API) che è il valore del  **Client** IDnella configurazione  [Adobe Granite OAuth Application e ](social-login.md#adobe-granite-oauth-application-and-provider)Providerconfiguration.
