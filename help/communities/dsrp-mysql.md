...
Una volta eseguito lo script, è necessario aggiornare la sezione `SCHEMAS`della `Navigator` per visualizzare il nuovo database. Utilizzate l&#39;icona di aggiornamento a destra di &#39;SCHEMAS&#39;:
