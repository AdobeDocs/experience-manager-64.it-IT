...
* **[!UICONTROL Configurazione]**
 padre (richiesta) In genere viene mantenuta come impostazione predefinita. Il valore predefinito è 
`/etc/cloudservices/translation`.

* **[!UICONTROL Titolo]**
 (obbligatorio) Immettere un titolo di visualizzazione di vostra scelta. Nessun valore predefinito.
...
* **** Sitestab: può essere lasciato come impostazione predefinita
* **** Comuni:
   * **[!UICONTROL Provider]**
...
* **** Assetstab: può essere lasciato come impostazione predefinita
