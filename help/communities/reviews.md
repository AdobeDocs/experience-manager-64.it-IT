...
La `Reviews`un componente è un composito di [ `Comments`](comments.md) e [ `Rating`](rating.md) componenti pronti per l’uso.
...
* **[!UICONTROL Recensioni contrassegno]**
...
* `Review Path`
   ...
   /content/sites/IT/page/jcr:content/content/primary/review
