...
1. Preparare una nuova configurazione:
   ...
   1. Copiare il contenuto della directory di configurazione Solr esistente in *new-config-dir*
      ...
      * Per Solr4: copiare *solr-install-dir*/example/solr/collection1/conf/&amp;ast;
      * Per Solr5: copiare *solr-install-dir*/server/solr/configsets/data_Driv_schema_configs/&amp;ast;
   1. Copiare **schema.xml** e **solrconfig.xml** scaricati in *new-config-dir* per sovrascrivere i file esistenti
...
1. Copiare nella stessa directory **schema.xml** e **solrconfig.xml** scaricati
...
1. Preparare una nuova configurazione:
   ...
   1. Copiare il contenuto della directory di configurazione Solr esistente su *new-config-dir*
      ...
      * Per Solr4: copiare *solr-install-dir*/example/solr/collection1/conf/&amp;ast;
      * Per Solr5: copiare *solr-install-dir*/server/solr/configsets/data_Driv_schema_configs/&amp;ast;
   1. Copiare **schema.xml** e **solrconfig.xml** estratti in *new-config-dir* per sovrascrivere i file esistenti
   ...
   1. Copiare la cartella **stopwords/** estratta in *new-config-dir* con conseguente *new-config-dir*/stopwords/&amp;ast;.txt
...
1. [Create una ](#create-a-collection) raccolta specificando i parametri necessari, ad esempio il numero di frammenti, il numero di repliche e il nome della configurazione.
1. Se il nome di configurazione era *not* fornito durante la creazione della raccolta, [collegare la raccolta appena creata](#link-a-collection-to-a-configuration-set) con la configurazione caricata su ZooKeeper
