...
Ciò che è, è l&#39;attività dei due studenti, `Riley Taylor` e `Sidney Croft. By s`selezionando il collegamento `Administration`per accedere alla console di moderazione, Quinn è in grado di utilizzare la [console di moderazione in massa](moderation.md) per moderare i propri post.
...
* Spostarsi dal menu principale in **[!UICONTROL Community > Risorse]**
* Selezionare il sito `Enablement Tutorial`
* Selezionare l&#39;icona `Report`per un riepilogo di tutte le risorse
* Selezionare una risorsa e quindi l&#39;icona `Report`per un report sulla risorsa
...
* Sull’autore
* Accesso con privilegi amministrativi
* Passa a **[!UICONTROL Community > Rapporti > Rapporto assegnazioni]**
...
* Sull’autore
* Accesso con privilegi amministrativi
* Passa a **[!UICONTROL Community > Rapporti > Rapporto visualizzazioni]**
* Selezionare un **[!UICONTROL sito]** dal menu a discesa (selezionare `Enablement Tutorial`)
