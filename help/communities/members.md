...
* Seleziona `Tools, Security, Users` per la navigazione globale
* Seleziona `Tools, Security, Groups` per la navigazione globale
...
* **[!UICONTROL Limiti]**
contributiSe questa opzione è selezionata, la capacità del membro di pubblicare contenuto è limitata.
...
* **[!UICONTROL Modifica]**
password: collegamento presente durante la modifica di un membro esistente. Consente a un amministratore della community di ripristinare una password per un membro.
