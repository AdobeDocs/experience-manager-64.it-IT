...
* Modello immagine Dynamic Media (Campaign)
...
Dopo che l&#39;immagine è stata caricata (e non prima), potete utilizzare la funzione di modifica locale [per ritagliare/ruotare l&#39;immagine come richiesto:](/help/sites-authoring/editing-content.md#edit-configure-copy-cut-delete-paste)
...
[I ](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/template-basics/quick-start-template-basics.html#template-basics) modelli di immagini Scene7 sono file immagine a più livelli, con contenuti e proprietà parametrizzabili per la variabilità. Il componente **Modello immagine** consente di utilizzare i modelli Dynamic Media Classic (già Scene7) nelle newsletter e di modificare i valori dei parametri dei modelli. Inoltre, potete utilizzare  variabili di metadati Adobe Campaign all&#39;interno dei parametri, in modo che ogni utente possa vedere l&#39;immagine in modo personalizzato.

![chlimage_1-111](assets/chlimage_1-111.png)

Fai clic su **Modifica** per configurare il componente. Potete configurare le impostazioni descritte in questa sezione. Questo modello di immagine Dynamic Media Classic (già Scene7) è descritto dettagliatamente in [componente Modello immagine Scene7](/help/assets/scene7.md#image-template).

Inoltre, il pannello dei parametri elenca tutti i parametri dei modelli definiti per il modello in Dynamic Media Classic (già Scene7). Per ciascuno di questi parametri, puoi personalizzare il valore, inserire variabili o ripristinarli ai loro valori predefiniti.
...
* **Vincoli -** Constraintdrop

   È possibile selezionare - **None** o **Date**- per aggiungere il vincolo di una data o nessun vincolo. Se si seleziona la data, la risposta che gli utenti immettono nel campo deve essere in un formato di data.
...
* **Attribuzione stile -**
LarghezzaConsente di regolare la larghezza del campo facendo clic o toccando il pulsante 
**+** e  **-** icons oppure immettere un numero.
...
* **Vincoli -** Constraintdrop
   ...
   È possibile selezionare - **None** o **Numeric** - per aggiungere il vincolo di un numero o di nessun vincolo. Se si seleziona un numero, la risposta che gli utenti immettono nel campo deve essere numerica.
...
* **Vincoli -** Constraintdrop
   ...
   È possibile selezionare - **None, Email,** o **Name (no umlauts)**- per aggiungere il vincolo di un indirizzo e-mail, nome o nessun vincolo. Se selezioni E-mail, le risposte inserite dagli utenti nel campo devono essere un indirizzo e-mail. Se selezionate un nome, deve essere un nome (gli umlauts non sono consentiti).
...
* **Attribuzione stile - Larghezza**
   ...
   Per regolare la larghezza del campo, tocca o fai clic sulle icone **+** e **-** oppure immetti un numero.
