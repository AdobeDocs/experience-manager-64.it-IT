...
* Per aggiungere direttamente contenuti [trascina una risorsa](#inserting-a-component-using-the-assets-browser) dal browser risorse.
...
Le opzioni di modifica effettive dipendono dal componente. Per alcuni componenti [tutte le azioni sono disponibili solo in modalità a schermo intero](#edit-content-full-screen-mode). Ad esempio:
...
Invece di passare ripetutamente dalla modalità di modifica a quella di [layout](/help/sites-authoring/responsive-layout.md) per cambiare un componente, puoi selezionare l’azione **Layout** di un componente per modificarne il layout, così da risparmiare tempo ed evitare di uscire dalla modalità di modifica.
...
Nel menu Informazioni pagina è presente l’opzione **Sblocca** e l’icona Blocca nella console Sites è sostituita dall’icona **Sblocca**.
