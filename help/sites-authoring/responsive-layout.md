...
* Utilizzo del [menu modalità della barra degli strumenti](/help/sites-authoring/author-environment-tools.md#page-modes) e scelta della modalità **Layout**

   * Seleziona la modalità **Layout** come per passare alla modalità **Modifica** o **Targeting**.
   * La modalità **Layout** diventa persistente e non la puoi abbandonare **** finché non ne selezioni un’altra dal selettore della modalità.
...
* In **Layout** mode you can tap/click on the **Drag components here** to select the entire component. Viene quindi visualizzata la barra degli strumenti per questa modalità.
   ...
   * **Mostra componenti** nascosti - Mostra tutti i componenti o singoli componenti. Il numero indica quanti componenti nascosti sono attualmente presenti. Il contatore mostra il numero di componenti nascosti.
   ...
   * **Mostra componenti** Seleziona i componenti principali per visualizzare la barra degli strumenti delle azioni con l’opzione **Mostra componenti nascosti**. In questo esempio, due componenti sono nascosti.
   ...
   Selezionando l’opzione **Mostra componenti nascosti**, i componenti attualmente nascosti nelle posizioni originali verranno visualizzati in blu.
