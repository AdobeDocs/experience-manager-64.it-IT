...
1. Tocca o fai clic sul pulsante **Stili** nella barra degli strumenti del componente **Elenco** per aprire il menu degli stili e modificare l’aspetto del componente.
   ...
   >[!NOTE]
   >
   >In questo esempio, gli stili di **Layout** (**Blocca** e **Griglia**) si escludono a vicenda, mentre le opzioni di **Display** (**Immagine** o **Data**) possono essere combinate. Questo può essere [configurato nel modello dall’autore dei modelli](/help/sites-authoring/style-system.md#as-a-template-author).
...
This property is set on the `cq:Component` node. Ad esempio:
