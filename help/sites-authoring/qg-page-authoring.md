...
Prima di passare alle informazioni specifiche, ecco una breve raccolta di consigli e suggerimenti generali che è bene tenere presenti, specialmente se sei abituato a utilizzare [l’interfaccia classica ambiente Authoring](/help/sites-classic-ui-authoring/classicui.md).
...
* Cambio di interfaccia
   ...
   * Può essere effettuato in varie posizioni. Consulta [Selezione dell’interfaccia](/help/sites-authoring/select-ui.md).
...
* I flussi di lavoro e le versioni ora non vengono più avviati/creati dall’Editor pagina, bensì dalla [Timeline](/help/sites-authoring/basic-handling.md#timeline) (accessibile dalla console).
...
1. Vista a schede:
   ...
   * Attiva la modalità di selezione [scegliendo la risorsa richiesta](/help/sites-authoring/basic-handling.md#viewing-and-selecting-resources) con:
...
* Verranno visualizzate le proprietà della pagina. È possibile apportare le modifiche desiderate e poi selezionare Salva per applicarle
