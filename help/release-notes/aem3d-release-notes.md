...
# AEM Note sulla versione 3D {#aem-d-release-notes}
...
AEM 3D supporta  tipi di risorse Adobe Dimension (Dn) e glTF. L’implementazione per questi tipi di risorse è sostanzialmente diversa da quella per i tipi 3D tradizionali descritti nella presente documentazione. Consultate [Utilizzo di  risorse Adobe Dimension](/help/assets/working-dimension-assets.md).
...
Vedere [Integrazione con Autodesk Maya](/help/assets/integrate-maya-with-3d.md).

Vedere anche [Installazione e configurazione AEM risorse 3D](/help/assets/install-config-3d.md) e [Impostazioni di configurazione avanzate](/help/assets/advanced-config-3d.md).

Vedere anche [Utilizzo di risorse 3D](/help/assets/assets-3d.md).
...
Vedere [Installazione e configurazione AEM 3D](/help/assets/install-config-3d.md).

Vedere anche [Integrazione AEM 3D con Autodesk Maya](/help/assets/integrate-maya-with-3d.md) e [Integrazione AEM 3D con Autodesk 3ds Max](/help/assets/integrating-aem-3d-with-autodesk-3ds-max.md).
...
| MA, MB | Autodesk nativo Maya | Solo Windows | Autodesk Maya è richiesto sul nodo Autore per abilitare questi formati di file. Vedere [Integrazione AEM 3D con Autodesk Maya](/help/assets/integrate-maya-with-3d.md). |
| JT | Siemens PLM Open CAD | Solo Windows | Autodesk Maya è richiesto sul nodo Autore per abilitare questi formati di file. Vedere [Integrazione AEM 3D con Autodesk Maya](/help/assets/integrate-maya-with-3d.md). |
| * | È possibile abilitare ulteriori formati di input 3D supportati da Autodesk Maya. Vedere [Abilitazione di formati aggiuntivi supportati da Maya](/help/assets/integrate-maya-with-3d.md#enabling-additional-formats-supported-by-maya). | Solo Windows | Autodesk Maya è richiesto sul nodo Autore per abilitare questi formati di file. Vedere [Integrazione AEM 3D con Autodesk Maya](/help/assets/integrate-maya-with-3d.md). |
| MAX | Autodesk nativo 3ds Max | Solo Windows | Autodesk 3ds Max è richiesto nel nodo autore per abilitare questo formato di file. Vedere [Integrazione AEM 3D con Autodesk 3ds Max](/help/assets/integrating-aem-3d-with-autodesk-3ds-max.md). |

## Miglioramenti e nuove funzionalità {#enhancements-and-new-features}
...
###  supporto Adobe Dimension {#adobe-dimension-support}
...
### Limitazioni relative al tipo di file {#file-type-restrictions}
