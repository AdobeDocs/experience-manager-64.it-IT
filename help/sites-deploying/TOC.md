...
+ Configurazione di AEM {#configuring}
   ...
   + [Rimozione di siti Geometrixx](removing-the-geometrixx-sites.md)
...
+ Ristrutturazione archivio {#restructuring}
   ...
   + [Ristrutturazione di Dynamic Media Repository in AEM 6.4](dynamicmedia-repository-restructuring-in-aem-6-4.md)
   + [Ristrutturazione dell’archivio dei moduli in AEM 6.4](forms-repository-restructuring-in-aem-6-4.md)
