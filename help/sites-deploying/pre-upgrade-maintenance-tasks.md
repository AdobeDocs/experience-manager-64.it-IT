...
* [Se necessario, aggiorna lo schema del database](pre-upgrade-maintenance-tasks.md#upgrade-the-database-schema-if-needed)
...
>
>Per un esempio di `LoginModule` configurazione in AEM 6, consultate [Configurazione di LDAP con AEM 6](/help/sites-administering/ldap-config.md).
...
* Create un backup degli utenti che causano il problema. Puoi farlo tramite Gestione pacchetti. Per ulteriori informazioni, vedere [Come utilizzare i pacchetti](/help/sites-administering/package-manager.md).
