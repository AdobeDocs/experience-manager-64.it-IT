...
* **Server applicazioni Web**: AEM può essere distribuito in modalità indipendente (include un server web Jetty integrato) o come applicazione web all’interno di un server applicazioni di terze parti (WebLogic, WebSphere, ecc.).
...
**Time-to-Market più rapido:** Grazie all’infrastruttura cloud flessibile di Adobe Managed Services, le organizzazioni possono pianificare, avviare e ottimizzare rapidamente le esperienze digitali di successo. Adobe gestisce l’architettura cloud senza richiedere capitale aggiuntivo, hardware o software e gli ingegneri Adobe Customer Success collaborano con l’architettura AEM, il provisioning, la personalizzazione per la connessione alle app back-end e le best practice per la pubblicazione.
...
Per ulteriori informazioni su Cloud Manager e sulle relative risorse, consulta [**Guida utente di Cloud Manager**](https://helpx.adobe.com/experience-manager/cloud-manager/user-guide.html).
...
* **cq-quickstart-6.4.0.jar:** Un eseguibile autonomo *barattolo* che include tutto il necessario per iniziare a utilizzare.

* **cq-quickstart-6.4.0.war:** A *guerra* per la distribuzione in un server applicazioni di terze parti.
...
1. Per avviare l&#39;istanza in un ambiente GUI, fare doppio clic sul pulsante **`cq-quickstart-6.4.0.jar`** file.
...
Se l&#39;istanza è stata installata dalla GUI, si aprirà automaticamente una finestra del browser e si aprirà anche una finestra dell&#39;applicazione desktop che mostra l&#39;host e la porta dell&#39;istanza e un interruttore di accensione/spegnimento:
