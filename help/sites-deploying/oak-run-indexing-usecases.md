...
## Caso d’uso 1 - Controllo della coerenza dell’indice {#usercase1indexconsistencycheck}
...
* **reindicizzazione** fuori banda: la reindicizzazione in rovere può essere effettuata separatamente da una configurazione AEM in esecuzione, riducendo così l&#39;impatto sull&#39;istanza AEM in uso;
...
* Impatto minimo sull&#39;esecuzione delle istanze AEM. La maggior parte delle letture può essere effettuata da server secondari e l&#39;esecuzione AEM cache non viene compromessa a causa di tutti i traversi necessari per la reindicizzazione;
...
1. Collegare lo `oak-run` stesso repository utilizzato da AEM in modalità di sola lettura ed eseguire l&#39;indicizzazione. Esempio di come ottenere questo risultato:
...
Per `SegmentNodeStore` le installazioni è possibile eseguire la reindicizzazione tramite un singolo comando di esecuzione della quercia. Tuttavia, l&#39;istanza AEM deve essere chiusa.
