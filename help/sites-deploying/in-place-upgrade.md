...
>[!NOTE]
>
>Questa pagina illustra la procedura di aggiornamento per AEM 6.4. Se disponete di un&#39;installazione distribuita su un server applicazione, consultate Procedura [di aggiornamento per le installazioni](/help/sites-deploying/app-server-upgrade.md)di Application Server.
