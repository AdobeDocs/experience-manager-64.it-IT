...
* [Pubblicare (attivare)](/help/sites-authoring/publishing-pages.md#publishing-pages) contenuti da un autore a un ambiente di pubblicazione.
...
>[!NOTE]
>
>Questo può essere combinato con l&#39;uso dell&#39; [ID utente agente](#settings) per selezionare contenuti diversi per la replica nei singoli ambienti di pubblicazione. Per ogni ambiente di pubblicazione:
>
