...
In AEM 6.4, i microkernel agiscono da persistence manager. La scelta di uno per soddisfare le esigenze dipende dallo scopo dell&#39;istanza e dal tipo di distribuzione che si sta considerando.
...
Per i siti che intendono implementare [AEM Communities](/help/communities/overview.md), si consiglia di [scegliere una distribuzione](/help/communities/working-with-srp.md) ottimizzata per la gestione di UGC pubblicate dai membri della community dall&#39;ambiente di pubblicazione.
