...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>Archivio</td> 
   <td>A: Supportato con limitazioni</td> 
  </tr> 
  <tr> 
...
1. Il sostegno a MongoDB 3.4 ha raggiunto la fine del ciclo di vita (EOL), mentre MongoDB 3.6 dovrebbe raggiungere l&#39;EOL il 30 aprile 2021. Si prega di notare che  Adobe fornirà solo supporto per AEM questioni relative ai prodotti in corso.
...
>
>Per eseguire AEM 6.4 con un database relazionale supportato, è necessario un contratto di assistenza separato con un fornitore di database.  Assistenza clienti di Adobe assisterà i problemi di qualificazione relativi all&#39;utilizzo di database relazionali con AEM 6.4.
>
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td>IBM AIX 7.2</td> 
   <td>A: Supportato con limitazioni (2,5,7)<br /> R: Sostegno limitato per i nuovi contratti</td> 
  </tr> 
 </tbody> 
</table>
