...
Affinché si verifichi la transcodifica corretta, l’amministratore deve [Installa FFmpeg](/help/sites-administering/config-video.md#install-ffmpeg) separatamente. Possono inoltre [Configurare i profili video](/help/sites-administering/config-video.md#configure-video-profiles) per l’utilizzo con elementi html5.
