...
>[!NOTE]
>
>Se utilizzi Dynamic Media in una distribuzione WAR, consulta la [documentazione relativa ai supporti dinamici](/help/assets/config-dynamic.md#enabling-dynamic-media).
