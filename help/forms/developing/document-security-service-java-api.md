...
description: 'Utilizzare l''API Java del servizio di gestione dei diritti per creare un criterio, modificare un criterio, eliminare un criterio, applicare un criterio a un documento PDF, rimuovere un criterio da un documento PDF, revocare un documento, ripristinare l''accesso a un documento revocato, controllare i documenti PDF protetti da policy, creare una filigrana, modificare una filigrana, cercare eventi e rimuovere un criterio da un documento Word. '
seo-description: Utilizzare l'API Java del servizio di gestione dei diritti per creare un criterio, modificare un criterio, eliminare un criterio, applicare un criterio a un documento PDF, rimuovere un criterio da un documento PDF, revocare un documento, ripristinare l'accesso a un documento revocato, controllare i documenti PDF protetti da policy, creare una filigrana, modificare una filigrana, cercare eventi e rimuovere un criterio da un documento Word.
