...
description: Utilizza l’API Java del Registro endpoint per aggiungere un endpoint EJB, aggiungi un endpoint SOAP, aggiungi un endpoint di cartelle controllate, aggiungi un endpoint e-mail, aggiungi un endpoint remoto, aggiungi un endpoint TaskManager, modifichi un endpoint, rimuovi un endpoint e recuperi informazioni sul connettore endpoint.
seo-description: Utilizza l’API Java del Registro endpoint per aggiungere un endpoint EJB, aggiungi un endpoint SOAP, aggiungi un endpoint di cartelle controllate, aggiungi un endpoint e-mail, aggiungi un endpoint remoto, aggiungi un endpoint TaskManager, modifichi un endpoint, rimuovi un endpoint e recuperi informazioni sul connettore endpoint.
