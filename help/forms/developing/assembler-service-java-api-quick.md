...
description: Il servizio Assembler consente di assemblare un documento PDF, smontare un documento PDF, assemblare un documento PDF crittografato, assemblare un documento PDF con la numerazione delle bates, assemblare un documento PDF non interattivo, determinare se un documento è conforme allo standard PDF/A, convalidare documenti DDX, assemblare documenti PDF con segnalibri, creare un documento DDX in modo dinamico, assemblare portfolio PDF e assemblare più frammenti XDP.
seo-description: Il servizio Assembler consente di assemblare un documento PDF, smontare un documento PDF, assemblare un documento PDF crittografato, assemblare un documento PDF con la numerazione delle bates, assemblare un documento PDF non interattivo, determinare se un documento è conforme allo standard PDF/A, convalidare documenti DDX, assemblare documenti PDF con segnalibri, creare un documento DDX in modo dinamico, assemblare portfolio PDF e assemblare più frammenti XDP.
...
Nell&#39;esempio di codice Java riportato di seguito viene sassemblato un documento PDF denominato *AssemblerResultPDF.pdf*. Il nome del documento DDX è *shell_disassemble.xml*. Ogni documento PDF smontato è denominato *ResultPDF[Number].pdf*. In altre parole, il primo documento PDF smontato è denominato *ResultPDF1.pdf.* Per informazioni sul documento  *shell_disassemble.* xmlDDX utilizzato in questo esempio di codice, vedere Scomposizione  [programmatica dei documenti](/help/forms/developing/assembling-pdf-documents.md#programmatically-disassembling-pdf-documents) PDF.
