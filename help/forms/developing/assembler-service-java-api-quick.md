...
L&#39;esempio di codice Java riportato di seguito unisce due documenti sorgente PDF denominati* map.pdf* e *directional.pdf* in un singolo documento PDF. Il nome del singolo documento PDF è *AssemblerResultPDF.pdf*. Il nome del documento DDX è *shell.xml*. (Vedere Assemblaggio [di documenti](/help/forms/developing/assembling-pdf-documents.md#programmatically-assembling-pdf-documents)PDF a livello di programmazione.)
