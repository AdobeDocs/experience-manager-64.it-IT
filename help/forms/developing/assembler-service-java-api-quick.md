...
description: Utilizzare il servizio Assembler per assemblare un documento PDF, smontare un documento PDF, assemblare un documento PDF crittografato, assemblare un documento PDF con la numerazione dei byte, assemblare un documento PDF non interattivo, determinare se un documento è conforme a PDF/A, convalidare documenti DDX, assemblare documenti PDF con segnalibri, creare un documento DDX in modo dinamico, assemblare portfolio PDF e assemblare più frammenti XDP.
seo-description: Utilizzare il servizio Assembler per assemblare un documento PDF, smontare un documento PDF, assemblare un documento PDF crittografato, assemblare un documento PDF con la numerazione dei byte, assemblare un documento PDF non interattivo, determinare se un documento è conforme a PDF/A, convalidare documenti DDX, assemblare documenti PDF con segnalibri, creare un documento DDX in modo dinamico, assemblare portfolio PDF e assemblare più frammenti XDP.
...
Nell’esempio di codice Java riportato di seguito vengono uniti in un singolo documento PDF due documenti sorgente PDF denominati* map.pdf* e *directions.pdf*. Il nome del singolo documento PDF è *AssemblerResultPDF.pdf*. Il nome del documento DDX è *shell.xml*. (Vedere [Assemblaggio programmatico di documenti PDF](/help/forms/developing/assembling-pdf-documents.md#programmatically-assembling-pdf-documents).)
...
Nell&#39;esempio di codice Java seguente viene smontato un documento PDF denominato *AssemblerResultPDF.pdf*. Il nome del documento DDX è *shell_disassemble.xml*. Ciascun documento PDF smontato si chiama *ResultPDF[Number].pdf*. In altre parole, il primo documento PDF smontato si chiama *ResultPDF1.pdf.* Per informazioni sul documento  *shell_disassemble.* xmlDDX utilizzato in questo esempio di codice, vedere Disassemblaggio  [programmatico di documenti PDF](/help/forms/developing/assembling-pdf-documents.md#programmatically-disassembling-pdf-documents).
