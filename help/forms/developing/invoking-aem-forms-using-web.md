...
>[!NOTE]
>
>È consigliabile non superare i 30 MB quando si compila un `BLOB` oggetto richiamandone il `setBinaryData` metodo. In caso contrario, esiste la possibilità che si verifichi un&#39;eccezione `OutOfMemory`*.*
