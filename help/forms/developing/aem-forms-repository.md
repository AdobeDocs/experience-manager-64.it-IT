...
description: Gestisci l'archivio AEM Forms per creare cartelle, scrivere, elencare, leggere, aggiornare risorse e cercare risorse utilizzando l'API Java e l'API Web Service. Inoltre, scopri come creare relazioni tra risorse, bloccare ed eliminare risorse.
