...
description: Gestire  repository AEM Forms per creare cartelle, scrivere, elencare, leggere, aggiornare risorse e cercare utilizzando l'API Java e l'API del servizio Web. Inoltre, scoprite come creare relazioni tra le risorse, bloccare ed eliminare le risorse.
