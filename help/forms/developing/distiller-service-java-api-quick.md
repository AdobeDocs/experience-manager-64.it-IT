...
description: Utilizza l’API Java di Distiller Service per convertire un file PostScript in un documento PDF.
...
L&#39;esempio di codice seguente converte un file PostScript denominato *Loan.ps *in un file PDF denominato *Loan.pdf*. (Vedi [Conversione di documenti PostScript in documenti PDF](/help/forms/developing/converting-postscript-pdf-documents.md#converting-postscript-to-pdf-documents).)
