...
Quando si passa un documento protetto, utilizzare il single sign-on e specificare un utente AEM forms con il ruolo* Document Upload Application User *role. Senza questo ruolo, l&#39;utente non può caricare un documento protetto. Puoi assegnare un ruolo a un utente a livello di programmazione. (Vedi [Gestione di ruoli e autorizzazioni](/help/forms/developing/users.md#managing-roles-and-permissions).)
