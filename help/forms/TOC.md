...
+ Guida introduttiva {#getting-started}
   ...
   + Materiali di riferimento AEM Forms {#aem-forms-reference-collaterals}
      + [Configurare e configurare i siti di riferimento di AEM Forms](using/setup-reference-sites.md)
...
+ Installare e configurare AEM Forms {#install-aem-forms}
   ...
   + Installare AEM Forms su OSGi {#osgi-installation}
      + [Piattaforme supportate per i moduli AEM su OSGi](https://helpx.adobe.com/it/experience-manager/6-4/sites/deploying/using/technical-requirements.html)
   ...
   + Installare AEM Forms su JEE {#jee-installation}
      ...
      + [Installare AEM Forms Workbench](http://help.adobe.com/en_US/AEMForms/6.1/InstallWorkbench/index.html)
      + [Installare e configurare Designer](using/installing-configuring-designer.md)
      + [Preparazione all&#39;installazione di AEM Forms (cluster server)](http://www.adobe.com/go/learn_aemforms_prepareInstallcluster_64)
      ...
      + [Configurazione di Adobe Experience Manager Forms su JEE nel cluster WebLogic](http://www.adobe.com/go/learn_aemforms_clusterWebLogic_64)
...
+ Aggiornare AEM Forms {#upgrade-aem-forms}
   ...
   + Aggiornare AEM Forms su OSGi {#aem-forms-osgi-upgrade}
      + [Aggiornamento a AEM 6.4 forms su OSGi](using/upgrade-forms-osgi.md)
   ...
   + Aggiornare AEM Forms su JEE {#aem-forms-jee-upgrade}
      ...
      + [Lista di controllo e pianificazione dell&#39;aggiornamento Adobe Experience Manager Forms su JEE](http://www.adobe.com/go/learn_aemforms_upgrade_checklist_64)
      + [Aggiornamento a AEM 6.4 forms su JEE](using/upgrade-forms-jee.md)
...
+ Guida per gli sviluppatori {#developer-reference}
   ...
   + Programmazione con AEM Forms su JEE {#programming-aem-forms-jee}
      ...
      + Richiamo di AEM Forms su JEE tramite API {#invoking-aem-forms-jee-apis}
         ...
         + [Creazione di applicazioni di Flash Builder che eseguono l’autenticazione SSO utilizzando token HTTP](developing/creating-flash-builder-applications-perform.md)
