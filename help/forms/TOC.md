...
# Guida di Adobe Experience Manager 6.4 Forms {#forms}

+ [Guida ai moduli di AEM 6.4](home.md)
...
+ Installare e configurare AEM Forms {#install-aem-forms}
   ...
   + Installa AEM Forms su OSGi {#osgi-installation}
      + [Piattaforme supportate per AEM Forms su OSGi](https://helpx.adobe.com/experience-manager/6-4/sites/deploying/using/technical-requirements.html)
   ...
   + Installare AEM Forms su JEE {#jee-installation}
      ...
      + [Installazione e distribuzione di AEM Forms su JEE utilizzando JBoss Turnkey](http://www.adobe.com/go/learn_aemforms_installTurnkey_64)
      ...
      + [Preparazione all’installazione di AEM Forms (server singolo)](http://www.adobe.com/go/learn_aemforms_prepareInstallsingle_64)
      + [Installazione e distribuzione di Adobe Experience Manager Forms su JEE per JBoss](http://www.adobe.com/go/learn_aemforms_installJBoss_64)
      + [Installazione e distribuzione di AEM Forms su JEE per WebLogic](http://www.adobe.com/go/learn_aemforms_installWebLogic_64)
      + [Installazione e distribuzione di Adobe Experience Manager Forms su JEE per WebSphere](http://www.adobe.com/go/learn_aemforms_installWebSphere_64)
      + [Installa Workbench di AEM Forms](http://help.adobe.com/en_US/AEMForms/6.1/InstallWorkbench/index.html)
      + [Installare e configurare Designer](using/installing-configuring-designer.md)
      + [Preparazione all’installazione di AEM Forms (cluster di server)](http://www.adobe.com/go/learn_aemforms_prepareInstallcluster_64)
      + [Configurazione di Adobe Experience Manager Forms su JEE nel cluster JBoss](http://www.adobe.com/go/learn_aemforms_clusterJBoss_64)
      + [Configurazione dei moduli Adobe Experience Manager su JEE nel cluster WebLogic](http://www.adobe.com/go/learn_aemforms_clusterWebLogic_64)
      + [Configurazione di Adobe Experience Manager Forms su JEE nel cluster WebSphere](http://www.adobe.com/go/learn_aemforms_clusterWebSphere_64)
...
+ Aggiornare AEM Forms {#upgrade-aem-forms}
   ...
   + Aggiornare AEM Forms su OSGi {#aem-forms-osgi-upgrade}
      + [Aggiornamento ad AEM 6.4 Forms su OSGi](using/upgrade-forms-osgi.md)
   ...
   + Aggiornare AEM Forms su JEE {#aem-forms-jee-upgrade}
      + [Preparazione all’aggiornamento di AEM Forms](http://www.adobe.com/go/learn_aemforms_prepareupgrade_64)
      + [Elenco di controllo e pianificazione dell’aggiornamento di Adobe Experience Manager Forms su JEE](http://www.adobe.com/go/learn_aemforms_upgrade_checklist_64)
      + [Aggiornamento ad AEM 6.4 Forms su JEE](using/upgrade-forms-jee.md)
      + [Aggiornamento ad Adobe Experience Manager Forms su JEE per JBoss](http://www.adobe.com/go/learn_aemforms_upgradeJBoss_64)
      + [Aggiornamento da LiveCycle ES4 SP1 ad Adobe Experience Manager Forms su JEE per JBoss](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-jboss-livecycle.pdf)
      + [Aggiornamento ad AEM Forms su JEE per JBoss Turnkey](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_64)
      + [Aggiornamento da LiveCycle ES4 SP1 ad Adobe Experience Manager Forms su JEE per JBoss Turnkey](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-turnkey-livecycle.pdf)
      + [Aggiornamento ad Adobe Experience Manager Forms su JEE per WebLogic](http://www.adobe.com/go/learn_aemforms_upgradeWebLogic_64)
      + [Aggiornamento da LiveCycle ES4 SP1 ad Adobe Experience Manager Forms su JEE per WebLogic](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-weblogic-livecycle.pdf)
      + [Aggiornamento ad Adobe Experience Manager Forms su JEE per WebSphere](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_64)
      + [Aggiornamento da LiveCycle ES4 SP1 ad Adobe Experience Manager Forms su JEE per WebSphere](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-websphere-livecycle.pdf)
...
+ Guida di riferimento per sviluppatori {#developer-reference}
   ...
   + [Riferimento API Java per AEM Forms su JEE](https://helpx.adobe.com/experience-manager/6-4/forms/ProgramLC/javadoc/index.html)
   + [API di Form Bridge per i moduli HTML5](using/form-bridge-apis.md)
   + [Riferimento API della libreria JavaScript per i moduli adattivi](https://helpx.adobe.com/experience-manager/6-4/forms/javascript-api/index.html)
   + [Servizio di assemblaggio e riferimento DDX](http://www.adobe.com/go/learn_aemforms_ddxRef_64)
