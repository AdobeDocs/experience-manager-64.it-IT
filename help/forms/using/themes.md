...
1. Nella pagina Temi , fai clic su **[!UICONTROL Crea > Tema]**.

   Viene avviata una procedura guidata per creare un tema.

1. Nella scheda Base della procedura guidata Crea tema , fornisci **[!UICONTROL Titolo]** e **[!UICONTROL Nome]** del tema. Si tratta di campi obbligatori.
...
1. Nella pagina Temi , fai clic su **[!UICONTROL Crea > Caricamento file]**.
...
* **Barra laterale**- Appare sul lato sinistro. Sono disponibili i seguenti elementi:
   ...
   * **Selettore:** Mostra il componente selezionato per lo stile e le relative proprietà che è possibile assegnare. Il selettore rappresenta tutti i componenti di un tipo. Se si seleziona un componente casella di testo in un tema per la formattazione, tutte le caselle di testo nel modulo o nella comunicazione interattiva erediteranno lo stile. I selettori consentono di selezionare un componente generico o un componente specifico per lo stile. Ad esempio, un componente campo è un componente generico e una casella di testo è un componente specifico.
      ...
      **Definizione dello stile di un componente specifico**:
   ...
   * **Visualizza CSS**: Consente di visualizzare i CSS del componente selezionato
   ...
   Inoltre, nella barra laterale, in basso è presente una freccia. Quando fai clic sulla freccia, ottieni altre due opzioni: **Simulazione riuscita** e **Simula errore.** Queste opzioni, insieme alle opzioni descritte sopra, sono discusse in dettaglio [di seguito](/help/forms/using/themes.md#using-rail).
...
1. Nella scheda Generale, individuare e selezionare un modulo o una comunicazione interattiva per il **[!UICONTROL Modulo/documento adattivo]** campo .
...
L’Editor tema consente di modificare un tema creato o caricato. Passa a **[!UICONTROL Forms e documenti > Temi]**, quindi seleziona un tema e aprilo. Il tema viene aperto nell’Editor tema.
...
**Figura:** *Barra degli strumenti del componente nella casella numerica dell’area di lavoro*
...
È ora possibile utilizzare i font disponibili in un servizio Web in un modulo adattivo o in una comunicazione interattiva. preconfigurato, [Typekit](https://typekit.com/), il servizio font web Adobe è disponibile come configurazione. Per utilizzare Typekit, crea un kit e font al suo interno e ottieni l’ID kit da [Sito web Typekit](https://typekit.com/).

Esegui i seguenti passaggi per configurare Typekit in AEM:

1. Nell’istanza di authoring, fai clic su ![adobeexperiencemanager](assets/adobeexperiencemanager.png)**[!UICONTROL Adobe Experience Manager > Strumenti ]**![martello](assets/hammer.png)**[!UICONTROL > Implementazione > Cloud Services ]**.
1. Sulla **[!UICONTROL Cloud Services]** pagina, passa a **[!UICONTROL Servizi di terzi]** >  **[!UICONTROL Typekit]** e fai clic su **[!UICONTROL Configura ora]** sotto Typekit. Se una configurazione è già disponibile, fai clic sul pulsante **+** per creare una nuova istanza.
...
1. In **[!UICONTROL Configurazione di Typekit]** selezionare un kit e fare clic su **[!UICONTROL Salva]**.
...
1. In modalità di modifica, seleziona un componente, quindi fai clic su ![a livello di campo](assets/field-level.png) > **[!UICONTROL Contenitore di moduli adattivi]**, quindi fai clic su ![cmppr](assets/cmppr.png).
...
1. Apri la comunicazione interattiva in modalità di modifica. Per aprire una comunicazione interattiva in modalità di modifica, seleziona un modulo e fai clic su **[!UICONTROL Apri]**.
1. In modalità di modifica, seleziona un componente, quindi fai clic su ![a livello di campo](assets/field-level.png) >**[!UICONTROL Contenitore documento]**, quindi fai clic su ![cmppr](assets/cmppr.png).

   È possibile modificare le proprietà del modulo nella barra laterale.

1. Nella barra laterale, sotto **[!UICONTROL Base]**, seleziona il tema dalla **[!UICONTROL Tema]** a discesa e fai clic su **[!UICONTROL Fine]** ![pulsante di controllo](assets/check-button.png).
...
1. Nell’istanza di authoring, passa a **[!UICONTROL Adobe Experience Manager > Forms > Temi]**.
...
* **Evitare risorse da un altro tema**
   ...
   Quando modifichi un tema, puoi sfogliare e aggiungere risorse (come le immagini) da altri temi. Ad esempio, si sta modificando lo sfondo di una pagina. Ad esempio, quando selezioni **[!UICONTROL Pagina]** ![pulsante di modifica](assets/edit-button.png)> **[!UICONTROL Sfondo > Aggiungi > Immagine]**, viene visualizzata una finestra di dialogo che consente di sfogliare e aggiungere immagini in altri temi.
