...
# Ottimizzazione delle prestazioni  server AEM Forms {#performance-tuning-of-aem-forms-server}
...
* **( AEM Forms solo su JEE)** Directory Global Document Storage (GDS). Il percorso predefinito è:
