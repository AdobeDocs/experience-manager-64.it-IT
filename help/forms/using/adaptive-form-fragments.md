...
In modalità di modifica, puoi trascinare nel frammento qualsiasi componente di modulo adattivo dalla barra laterale di AEM. Per informazioni sui componenti per moduli adattivi, consulta [Introduzione alla creazione di moduli adattivi](/help/forms/using/introduction-forms-authoring.md).
...
* (**Solo Mac**) Per garantire che la funzionalità dei frammenti di modulo funzioni perfettamente in tutti gli scenari, aggiungi la seguente voce al file /private/etc/hosts:
   ...
   **Macchina** host: Il computer Apple Mac su cui viene implementato AEM Forms.
