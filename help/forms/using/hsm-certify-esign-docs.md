...
1. Aprire il **servizio di configurazione delle credenziali HSM** e specificare i valori per i campi seguenti:
   ...
   **Nota:** *durante la configurazione di Etoken, specificate un valore numerico per il campo ID slot HSM. Per il funzionamento delle operazioni di firma è necessario un valore numerico.*
