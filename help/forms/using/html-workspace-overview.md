...
È possibile approvare più attività dello stesso tipo. Dopo aver selezionato un&#39;attività per l&#39;approvazione, rimangono abilitate solo le attività con lo stesso processo, con gli stessi nomi di attività e le stesse opzioni di route. Per informazioni dettagliate sull&#39;implementazione, vedere [Uso degli elenchi delle operazioni da eseguire](/help/forms/using/todo-lists.md).
...
L&#39;articolo [customization](introduction-customizing-html-workspace.md) spiega i tipi di tali personalizzazioni.
