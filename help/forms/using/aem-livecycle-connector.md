...
AEM connettore LiveCycle fa parte del pacchetto [aggiuntivo](/help/forms/using/installing-configuring-aem-forms-osgi.md)AEM Forms. Dopo aver installato il pacchetto  del componente aggiuntivo AEM Forms, eseguite i seguenti passaggi per aggiungere i dettagli del server di LiveCycle AEM Console Web.
...
### Bundle SDK client LiveCycle di  Adobe {#adobe-livecycle-client-sdk-bundle}
...
###  Adobe Bundle client LiveCycle Workflow {#adobe-livecycle-workflow-client-bundle}
...
###  Adobe pacchetto client Application Manager {#adobe-livecycle-application-manager-client-bundle}
...
### Pacchetto client Assembler LiveCycle di  Adobe {#adobe-livecycle-assembler-client-bundle}
...
###  Adobe Modulo di integrazione dei dati del client {#adobe-livecycle-form-data-integration-client-bundle}
...
###  pacchetto client LiveCycle Rights Manager {#adobe-livecycle-rights-manager-client-bundle}
...
###  Adobe Pacchetto Firme LiveCycle Client {#adobe-livecycle-signatures-client-bundle}
