...
Questa esercitazione è un passaggio della serie [Crea il primo modulo](create-your-first-adaptive-form.md) adattivo. Si consiglia di seguire le serie in sequenza cronologica per comprendere, eseguire e dimostrare l&#39;uso completo dell&#39;esercitazione.
...
1. Nel pannello Selettori, individuate l’opzione **Intestazione** > **Testo** . Il pannello Selettori si trova a sinistra dell’editor di temi. Se il pannello non è visibile, toccate ![Attiva/disattiva pannello](assets/toggle-side-panel.png) laterale.
