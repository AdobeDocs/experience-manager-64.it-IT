...
* Una cartella esaminata ha diverse proprietà, vedere [Proprietà cartella esaminata](/help/forms/using/watched-folder-in-aem-forms.md#watchedfolderproperties).
...
1. Toccate **Avanzate**. La scheda avanzata contiene altri campi. La maggior parte di questi campi contiene un valore predefinito.
   ...
   * **Includi file con pattern:** specificate un elenco delimitato da punti e virgola (;) di pattern utilizzato dalla cartella esaminata per determinare le cartelle e i file da acquisire e acquisire. Ad esempio, se il pattern di file Includi è input&amp;ast;, tutti i file e le cartelle che corrispondono a input&amp;ast; vengono prese. Per ulteriori informazioni, vedere [Guida di amministrazione](/help/forms/using/admin-help/configuring-watched-folder-endpoints.md)
