...
# Installazione workbench {#install-workbench}
...
* Scaricate e installate la versione più recente di  Adobe AIR (da <a href="http://www.adobe.com/it/">www.adobe.com</a>) richiesta per Community Help Client, integrata con Workbench.
...
1. Selezionare **Designer** Adobe, selezionare **Questa funzione non sarà disponibile**, quindi fare clic su **Avanti**
...
1. I seguenti elementi sono ora installati nel computer:
   * **Workbench**: Per eseguire Workbench dal menu Start, selezionare Tutti i programmi >  AEM Forms > Workbench, se si desidera memorizzare la cartella dei collegamenti. Per ulteriori informazioni, vedere la documentazione di Workbench in uso.
