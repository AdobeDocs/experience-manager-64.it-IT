...
Sono incluse anche le informazioni necessarie per configurare il sistema in modo da supportare i processi di aggiornamento Adobe® AEM Forms® Enterprise Suite (ES) Update 1 (8.2.x) e Adobe® AEM Forms® Enterprise Suite 2 (ES2).
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td><p>Esercitazione per la creazione di un’applicazione AEM Forms e per il test nello spazio di lavoro</p> </td> 
   <td><p><a href="http://adobe.com/go/learn_aemforms_firstapp_ds_65">Creazione della prima applicazione</a><br /> AEM Forms <br /> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td><p><a href="https://www.adobe.com/account/sign-in.supportportal.html">Contattare il supporto</a><br /> Adobe Enterprise <br /> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Scaricate e installate la versione più recente di Adobe AIR (da <a href="http://www.adobe.com/">www.adobe.com</a>) richiesta per Community Help Client, integrata con Workbench.
* Java™ Runtime Environment (JRE) 6.0 aggiornamento 22 o successivo aggiornamento a 6.0 *Nuovo per 10*.
...
>[!NOTE]
>
>Se sul computer è installato Adobe® Acrobat® X, assicurarsi di disinstallarlo prima di installare Workbench. È possibile reinstallare Acrobat dopo l&#39;installazione di Workbench.
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>Nessuno.  
L'installazione di Workbench rileva nel computer un'istanza di Designer installata con Acrobat Pro o Acrobat Pro Extended.
...
### Per disinstallare Designer incluso con Acrobat Pro o Acrobat Pro Extended {#uninstall-designer-included-with-acrobatpro-or-acrobatextended}

1. Vai al Pannello di **controllo > Programmi > Programmi e funzionalità**
1. Nell&#39;elenco Programmi attualmente installati, selezionare **Adobe Acrobat Pro** o **Adobe Acrobat Pro Extended**.
1. Fate clic su **Cambia** , quindi su **Avanti**.
1. Selezionare **Modifica** , quindi fare clic su **Avanti**.
1. Selezionare **Adobe Designer**, selezionare **Questa funzione non sarà disponibile**, quindi fare clic su **Avanti**
1. Click **Update** and then click **Finish**

### Per disinstallare Designer incluso con Acrobat Pro o Acrobat Pro Extended su Windows 10 {#uninstall-designer-included-with-acrobatpro-or-acrobatextended-windows10}
...
1. I seguenti elementi sono ora installati nel computer:
   * **Workbench**: Per eseguire Workbench dal menu Start, selezionare Tutti i programmi > AEM Forms > Workbench, se si sceglie di archiviare la cartella dei collegamenti. Per ulteriori informazioni, vedere la documentazione di Workbench in uso.
...
I processi AEM Forms Update 1 e LiveCycle ES2 possono essere aggiornati alle applicazioni AEM Forms tramite l&#39;Aggiornamento guidato. Per ulteriori informazioni, vedere Aggiornamento della documentazione sugli artifact legacy nella Guida di Workbench.
...
* Workbench_DVD/Additional/eclipseScaricare e installare Eclipse 3.6 da <a href="https://www.eclipse.org/downloads/">www.eclipse.org/downloads</a>.
...
1. Seguire le istruzioni riportate nelle schermate successive per distribuire la funzione Workbench in Eclipse.
   ...
   >[!NOTE]
   >
   >Il plug-in Adobe AEM Forms Discovery per Flash Builder consente di creare rapidamente applicazioni Adobe Flex e AIR che richiamano un servizio che fa parte di AEM Forms attraverso i suoi endpoint remoti. Per informazioni su come installare e aggiornare il plug-in, consultate **Link Required**.
