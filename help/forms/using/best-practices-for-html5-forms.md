...
* Abilita la compressione web. Riduce le dimensioni delle richieste e delle risposte provenienti da un modulo. Per maggiori dettagli, vedi [Ottimizzazione delle prestazioni del server AEM forms](https://helpx.adobe.com/aem-forms/6-3/performance-tuning-aem-forms.html).
