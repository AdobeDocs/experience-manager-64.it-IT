...
Ottimizzate le prestazioni del vostro Forms HTML5 basato su XFA.
...
* Utilizzate l&#39;opzione Riduci in AEM Configuration Manager (Gestione libreria HTML Day CQ) per comprimere i file JavaScript e CSS. Per informazioni dettagliate, consultate Impostazioni [di configurazione](/help/sites-deploying/osgi-configuration-settings.md)OSGi.
* Abilita compressione Web. Riduce la dimensione delle richieste e delle risposte originate da un modulo. Per informazioni dettagliate, vedere Ottimizzazione [delle prestazioni del server](https://helpx.adobe.com/it/aem-forms/6-3/performance-tuning-aem-forms.html)AEM moduli.
...
[ ![Scheda di riferimento rapido sulle procedure ottimali per HTML5 Forms](do-not-localize/best-practices_reference_card.png)](assets/html5_forms_best_practices_reference_card.pdf)