...
Prima di eseguire i passaggi indicati sopra, accertatevi di seguire i passaggi elencati in [Procedura generica per  personalizzazione dell&#39;area di lavoro AEM Forms](/help/forms/using/generic-steps-html-workspace-customization.md).

>[!NOTE]
>
>Per modificare la lingua della schermata di accesso &#39;area di lavoro AEM Forms, vedere [Creazione di una nuova schermata di accesso](/help/forms/using/creating-new-login-screen.md).
...
1. Eseguire tutte le modifiche semantiche elencate nell&#39;articolo [Personalizzazione area di lavoro](/help/forms/using/introduction-customizing-html-workspace.md).
...
È necessario un pacchetto di sviluppo per localizzare l&#39;API *datepicker *API. Per informazioni dettagliate sulla creazione del pacchetto di sviluppo, consultate [Creazione  codice dell&#39;area di lavoro AEM Forms](introduction-customizing-html-workspace.md#building-html-workspace-code).
