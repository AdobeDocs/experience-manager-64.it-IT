...
Per ulteriori informazioni sul funzionamento dell’app AEM Forms con il server AEM Forms, vedi [Conard ottiene il compito di valutazione](/help/forms/using/gov-reference-site-walkthrough.md#contard-assessment-task) nella documentazione relativa al rifiuto.
...
1. Per scaricare il pacchetto, apri `https://<server>:<port>/crx/de/content/forms/mobileapps/src/adobe-lc-mobileworkspace-src-<version>.zip` nel browser.
