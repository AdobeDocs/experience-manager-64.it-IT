...
1. Fai clic con il pulsante destro del mouse sul nodo del test (qui **afTestRegistration)**, quindi fai clic su **[!UICONTROL Crea > Crea file]**. Denomina il file js.txt e fai clic su **[!UICONTROL OK]**.
