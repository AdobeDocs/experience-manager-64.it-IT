...
**Figura:** *un modulo che utilizza il layout reattivo come mostrato in un piccolo schermo*
...
**Figura:** *un modulo con layout reattivo come mostrato su uno schermo di grandi dimensioni*
...
**Figura:** *espressione completamento passaggio nel layout della procedura guidata per un modulo a più passaggi*

![Un modulo con layout guidato](assets/wizard-layout.png)

**Figura:** *Creazione guidata modulo*
...
**Figura:** *le schede appaiono a sinistra di un pannello*
...
**Figura:** *Layout dei dispositivi mobili con titoli dei pannelli nelle intestazioni del modulo*
...
**Figura:** *Layout dei dispositivi mobili senza titoli del pannello nelle intestazioni del modulo*
