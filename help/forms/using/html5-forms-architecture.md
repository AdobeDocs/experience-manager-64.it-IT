...
**Figura:** *Flusso di lavoro di HTML5 forms*
...
Quando un utente invia il modulo, il browser invia lo stato del modulo in formato JSON al [invia proxy di servizio](/help/forms/using/service-proxy.md); il proxy del servizio di invio genera un codice XML di dati utilizzando i dati JSON e invia tale dato XML per inviare l’endpoint.

## Componenti {#components}

È necessario un pacchetto aggiuntivo di AEM Forms per abilitare HTML5 forms. Per informazioni sull&#39;installazione del pacchetto aggiuntivo di AEM Forms, vedi [Installazione e configurazione di AEM Forms](/help/forms/using/installing-configuring-aem-forms-osgi.md).
