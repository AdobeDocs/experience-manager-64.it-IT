...
![Flusso di lavoro](assets/cacheworkflow.png)**per moduli HTML5:** *Flusso di lavoro per moduli HTML5*
...
Quando un utente invia il modulo, il browser invia lo stato del modulo in formato JSON al proxy [del servizio di](/help/forms/using/service-proxy.md)invio; quindi il proxy del servizio di invio genera un XML di dati utilizzando i dati JSON e invia l&#39;XML di dati per inviare l&#39;endpoint.

## Componenti {#components}

Per abilitare i moduli HTML5 è necessario  pacchetto aggiuntivo AEM Forms. Per informazioni sull&#39;installazione  pacchetto aggiuntivo AEM Forms, consultate [Installazione e configurazione  AEM Forms](/help/forms/using/installing-configuring-aem-forms-osgi.md).
...
Per aggiornare queste impostazioni, andate all&#39;Admin Console CQ Felix  (disponibile in `https://[server]:[port]/system/console/configMgr`), cercate e selezionate Configurazione Forms mobile.
