...
**lavoro moduli HTML5Figura:flusso di lavoro** *moduli HTML5*
...
Quando un utente invia il modulo, il browser invia lo stato del modulo in formato JSON al [proxy del servizio ](/help/forms/using/service-proxy.md); quindi il proxy del servizio di invio genera un XML di dati utilizzando i dati JSON e invia l&#39;XML di dati per inviare l&#39;endpoint.
