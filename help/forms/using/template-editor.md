...
1. Nella console Modello, tocca **[!UICONTROL Crea]** all’interno della cartella creata.
1. Nella sezione Scegli un tipo di modello , seleziona **[!UICONTROL Modello di modulo adattivo]** e tocca **[!UICONTROL Avanti]**.
1. Nella sezione Template Details (Dettagli modello), specifica un Titolo modello e tocca **[!UICONTROL Create]** (Crea).
...
Per informazioni sull’editor dell’interfaccia touch, consulta [Introduzione alla creazione di moduli adattivi](/help/forms/using/introduction-forms-authoring.md) .
...
Vedere [Barra laterale](/help/forms/using/introduction-forms-authoring.md#sidebar).
...
Ogni componente dispone di proprietà che migliorano l’acquisizione e la manipolazione dei dati. Ad esempio, puoi abilitare la proprietà **[!UICONTROL Campo obbligatorio]** di un componente. Gli autori possono specificare un messaggio che i clienti visualizzano ignorando la compilazione di un campo obbligatorio. Specifica il messaggio nella proprietà **[!UICONTROL Messaggio campo richiesto]** .
...
1. Passa a **[!UICONTROL Adobe Experience Manager > Strumenti > Modelli]** e apri la cartella in cui hai creato il modello.
...
Dopo aver creato e abilitato un modello, questo è disponibile in Forms Manager quando si crea un modulo adattivo. Per utilizzare un modello e creare un modulo adattivo, consultare [Creazione di un modulo adattivo](/help/forms/using/creating-adaptive-form.md).
...
1. Accedi all&#39;istanza di authoring di AEM Forms e passa a **[!UICONTROL Strumenti > Operazioni > Console web]**.

   >[!NOTE]
   >
   >L’URL della console Web AEM è `https://[server]:[port]/system/console/configMgr`

1. Individua e apri le impostazioni **[!UICONTROL Configurazione FormsManager]** :
