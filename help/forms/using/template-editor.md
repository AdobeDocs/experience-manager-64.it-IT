...
Vedi [Introduzione alla creazione di moduli adattivi](/help/forms/using/introduction-forms-authoring.md) per comprendere l’editor dell’interfaccia utente touch.
...
Vedi [Barra laterale](/help/forms/using/introduction-forms-authoring.md#sidebar).
...
1. Passa a **[!UICONTROL Adobe Experience Manager > Strumenti > Modelli]**, quindi apri la cartella in cui hai creato il modello.
...
Dopo aver creato e abilitato un modello, questo è disponibile in Forms Manager quando si crea un modulo adattivo. Per utilizzare un modello e creare un modulo adattivo, consulta [Creazione di un modulo adattivo](/help/forms/using/creating-adaptive-form.md).
...
1. Individua e apri la **[!UICONTROL Configurazione di FormsManager]** impostazioni:
   ...
   * Per visualizzare o nascondere i modelli di modulo adattivo predefiniti aggiunti nelle versioni Forms 6.0 o Forms 6.1 di AEM ma ora obsoleti, seleziona o deseleziona la **Includi modelli AF AEM 6.0** opzione . Se questa opzione è selezionata, per avere effetto è necessario **[!UICONTROL Includi modelli predefiniti AF e AD]** configurazione da abilitare.
