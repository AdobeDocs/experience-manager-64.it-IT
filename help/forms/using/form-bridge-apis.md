...
* **Input**:
   ...
   * **contesto**: L&#39;oggetto a cui è impostato il contesto (questo) della funzione *handler *handler.
...
* **Uscita:** Oggetto contenente il risultato come Array nella proprietà *data *property
