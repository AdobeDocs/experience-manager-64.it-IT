...
* **Input:**
   ...
   * **** value: Array contenente valori corrispondenti alle espressioni Som fornite in un **determinato** array. Se il tipo di dati del valore non è lo stesso di fieldType, il valore non viene modificato.
