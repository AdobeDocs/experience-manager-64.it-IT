...
![](assets/we-finance-home.png) we-finance-home **** Figure: Portale *organizzazione*

![](assets/employee-dashboard.png) dipendente-dashboard **** Figura: Pannello *dipendente*
...
![](assets/conflict-inbox.png) inbox **** Figura: Posta in arrivo di *Gloria*

![](assets/conflict-approved.png) approvato **in conflitto** Figura: Attività *Apri*
...
![](assets/we-finance-home-1.png) we-finance-home-1 **** Figura: Portale *organizzazione*

![](assets/employee-dashboard-1.png) dipendente-dashboard-1 **** Figura: Pannello *dipendente*
...
![](assets/corporate-card-inbox.png) scheda aziendale-inbox **** Figura: Posta in arrivo di *Gloria*

![](assets/corporate-card-approved.png) scheda aziendale approvata **** Figura: Attività *Apri*
...
![](assets/we-finance-home-2.png) we-finance-home-2 **** Figura: Portale *organizzazione*

![](assets/employee-dashboard-2.png) dipendente-dashboard-2 **** Figura: Pannello *dipendente*
...
![](assets/expense-report-inbox.png) cost-report-inbox **** Figure: Posta in arrivo di *Gloria*

![](assets/expense-report-approved.png) nota spese approvata **** Figura: Attività *Apri*
...
![](assets/we-finance-home-3.png) we-finance-home-3 **** Figura: Portale *organizzazione*

![](assets/employee-dashboard-3.png) dipendente-dashboard-3 **** Figura: Pannello *dipendente*
...
![](assets/leave-inbox.png) left-inbox **** Figure: Posta in arrivo di *Gloria*

![](assets/leave-approved.png) omologato **** per il congedo: Attività *Apri*
