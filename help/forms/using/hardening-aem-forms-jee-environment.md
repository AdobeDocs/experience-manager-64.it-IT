...
1. Assegnare al nuovo account utente le autorizzazioni Lettura ed Esegui, Elenca contenuto cartella e Lettura per l&#39;elemento delle directory di contenuto web AEM Forms su JEE.
...
Utilizza la ***LC_GLOBAL_ALLOWED_REFERER_EXCEPTION*** Elenco per Eccezioni referente consentite a livello globale, ad esempio per definire le eccezioni applicabili a tutte le applicazioni. Questo elenco contiene solo URI con percorso assoluto (ad esempio  `/index.html`) o un percorso relativo (ad esempio,  `/sample/`). È inoltre possibile aggiungere un&#39;espressione regolare alla fine di un URI relativo, ad esempio:  `/sample/(.)*`.
...
1. Assegna al nuovo account utente le autorizzazioni Lettura ed esecuzione, Elenca contenuto cartella e Lettura per AEM Forms sulle directory dei contenuti web JEE.
