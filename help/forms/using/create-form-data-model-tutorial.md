...
Per ulteriori informazioni sull&#39;integrazione dei dati del modulo e sul modello di dati del modulo, vedere [Integrazione dei dati di AEM Forms](data-integration.md).
...
1. Configura il database MySQL come origine dati:
   ...
   1. Nella finestra di dialogo di configurazione, specifica i seguenti dettagli:
      ...
      * **Query di convalida:** specifica una query SQL SELECT per convalidare le connessioni dal pool. La query deve restituire almeno una riga. Ad esempio, **seleziona &amp;ast; da customer**.
