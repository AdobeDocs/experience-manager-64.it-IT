...
![Componente Ricerca e filtro in una ](assets/fp-grid-viw.png)
**paginaFigura:Componente** *Ricerca e filtro in una pagina con layout Griglia*
...
La finestra di dialogo **[!UICONTROL Edit]** include diverse schede che forniscono le opzioni di configurazione descritte nella tabella seguente. Al termine, toccare **[!UICONTROL OK]** per salvare la configurazione.
...
**PredicateFigura:pannello di** *ricerca con data, testo completo, proprietà e predicato tag*
...
1. Specificate quanto segue:
   ...
   * **[!UICONTROL Tipo:]** L’unica opzione disponibile è  **[!UICONTROL Ultima data]** modifica.
   ...
   * **[!UICONTROL Etichetta data finale:]** Etichetta o didascalia per il campo data di fine.
...
1. Toccate il componente, quindi toccate ![settings_icon](assets/settings_icon.png). Viene visualizzata la finestra di dialogo Modifica.
1. Specificare il titolo nel campo **[!UICONTROL Titolo principale]**.
1. Toccate **[!UICONTROL Ok]**.
...
1. Toccate il componente, quindi toccate ![settings_icon](assets/settings_icon.png). Viene visualizzata la finestra di dialogo **[!UICONTROL Modifica]**.
1. Nella scheda **[!UICONTROL Generale]**, specificare l&#39;etichetta di ricerca. Il valore predefinito è **[!UICONTROL Properties]**.

1. Nella scheda **[!UICONTROL Opzioni]**, toccare **[!UICONTROL Aggiungi elemento]**.
...
Per collegare un modulo da un punto qualsiasi della pagina, utilizzare il componente Collegamento. Per ulteriori informazioni sul componente collegamento, vedere [Incorporazione del componente collegamento in una pagina](/help/forms/using/embedding-link-component-page.md).

Per elencare i moduli in stato bozza e quelli già inviati, utilizzare il componente **[!UICONTROL Bozze e invii]**. Per ulteriori informazioni, vedere [Personalizzazione di bozze e invii, componente](/help/forms/using/draft-submission-component.md).
...
![Screenshot del ](assets/search_lister.png)
**componente Ricerca e ListerFigura:** *Ricerca e Lister*

## Personalizzazione di una pagina del portale dei moduli {#customizing-a-forms-portal-page-br}

È possibile personalizzare una pagina del portale dei moduli per fornire un aspetto distinto alla pagina. Potete inoltre aggiungere metadati per migliorare l&#39;esperienza di ricerca, modificare il layout della pagina e aggiungere stili CSS personalizzati. Per ulteriori informazioni, vedere [Personalizzazione dei modelli per i componenti di Forms Portal](/help/forms/using/customizing-templates-forms-portal-components.md).

&#39;interfaccia utente di AEM Forms consente di aggiungere metadati personalizzati ai moduli. I metadati personalizzati sono utili per fornire agli utenti finali un&#39;esperienza di elenco e ricerca dei moduli. Per ulteriori informazioni sui metadati personalizzati, consultate [Personalizzazione dei modelli per i componenti di Forms Portal](/help/forms/using/customizing-templates-forms-portal-components.md).

Dal portale dei moduli sono incluse le azioni di rendering. È possibile personalizzare il portale dei moduli per aggiungere ulteriori azioni. Per informazioni dettagliate, vedere [Aggiunta di azioni personalizzate agli elementi dell&#39;elenco dei moduli.](/help/forms/using/add-custom-action-form-lister.md)
