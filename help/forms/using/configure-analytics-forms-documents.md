...
1. Nella schermata Impostazioni account generali, abilitate **Reporting geografico** e fate clic su **Salva**.
...
1. Nell&#39;angolo in alto a sinistra, fare clic su **Adobe Experience Manager** > **Strumenti** ![strumenti](assets/tools.png) **Cloud Services** > **Cloud Services precedenti**.
...
1. Nell&#39;istanza di creazione, aprire AEM Gestione configurazione console Web all&#39;indirizzo https://&lt;*server*>:&lt;*port*>/system/console/configMgr.
