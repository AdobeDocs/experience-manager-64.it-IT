...
1. Selezionare una delle opzioni seguenti:
   ...
   * Se si desidera rimuovere alcuni font non esistenti nel server dei moduli, immettere i nomi di tali font nel **Aggiungi font da rimuovere** scatola. Fai clic su **Aggiungi**.
...
**[!UICONTROL Converti informazioni documento]**: Aggiunge informazioni sul documento dalla finestra di dialogo Proprietà del file di origine, tra cui titolo, oggetto, autore, parole chiave, manager, azienda, categoria e commenti. Questa opzione è selezionata per impostazione predefinita.
...
**[!UICONTROL Abilita Accessibilità E Reflow Con Adobe PDF Con Tag]**: Incorpora i tag nel file PDF. Questa opzione è deselezionata per impostazione predefinita.

**[!UICONTROL Convertire Multimedia In PDF Multimedia]**: Converte i file multimediali in file multimediali PDF, ove possibile. Questa opzione è selezionata per impostazione predefinita.
...
**[!UICONTROL Salvare Le Transizioni Diapositive In Adobe PDF]**: Converte le transizioni delle diapositive. Questa opzione è selezionata per impostazione predefinita.
...
1. **[!UICONTROL Converti informazioni documento]**: Aggiunge informazioni sul documento dalla finestra di dialogo Proprietà del file di origine, tra cui titolo, oggetto, autore, parole chiave, manager, azienda, categoria e commenti. Questa opzione è selezionata per impostazione predefinita.
...
**[!UICONTROL Aggiungere Segnalibri Ad Adobe PDF]**: Converte i titoli in segnalibri. Questa opzione è selezionata per impostazione predefinita.

**[!UICONTROL Allega File Di Origine Ad Adobe PDF]**: Aggiunge il file di origine al file PDF come allegato.

**[!UICONTROL Convertire Riferimenti E Sommario In Collegamenti]**: Converte tutti i riferimenti incrociati e le voci del sommario in collegamenti. Questa opzione è selezionata per impostazione predefinita.

**[!UICONTROL Abilita Accessibilità E Reflow Con Adobe PDF Con Tag]**: Incorpora i tag nel file PDF. Questa opzione è selezionata per impostazione predefinita.
...
**Converti informazioni documento**: Aggiunge informazioni sul documento dalla finestra di dialogo Proprietà del file di origine, tra cui titolo, oggetto, autore, parole chiave, manager, azienda, categoria e commenti. Questa opzione è selezionata per impostazione predefinita. Questa opzione è attivata per impostazione predefinita.
...
**Aggiungere Segnalibri Ad Adobe PDF**: Converte i titoli in segnalibri. Questa opzione è selezionata per impostazione predefinita.
...
**Apri Il Pannello Livelli Quando Visualizzato In Adobe Acrobat**: Se i livelli di Visio non sono appiattiti, apre una finestra in cui è possibile specificare i livelli che vengono mantenuti nel file PDF quando vengono aperti con Acrobat. Questa opzione è selezionata per impostazione predefinita.
