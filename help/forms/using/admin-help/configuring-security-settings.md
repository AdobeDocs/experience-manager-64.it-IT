...
**Ad Eccezione Dell’Estrazione Delle Pagine:** Consente agli utenti di modificare il documento utilizzando qualsiasi metodo presente nel Elenco Consentiti Modifiche , ad eccezione delle pagine rimosse.
...
**Attiva l&#39;accesso al testo dei dispositivi degli Reader per ipovedenti:** Consente agli utenti con problemi di vista di leggere il documento utilizzando gli assistenti vocali. Tuttavia, gli utenti non possono copiare o estrarre il contenuto del documento. Questa opzione è disponibile solo se è selezionato un livello di cifratura elevato.
