...
**Utente applicazione di caricamento documenti:** Può caricare i documenti tramite Flex Remoting.

**Amministratore Forms:** Può visualizzare e modificare le impostazioni dalla pagina Forms in Admin Console

**AEM moduli Contentspace Administrator:** Può visualizzare e modificare le impostazioni dalla pagina Content Services (obsoleto) nella console di amministrazione

**AEM moduli Contentspace Utente:** Accesso alle pagine Web Contentspace (obsoleto)
...
**AEM modulo Amministratore del connettore FileNet:** Può visualizzare e modificare le impostazioni dalla pagina Connettore per IBM FileNet nella console di amministrazione

**AEM moduli amministratore del connettore IBM CM:** Può visualizzare e modificare le impostazioni dalla pagina Connettore per IBM Content Manager nella console di amministrazione

**Amministratore Rights Management:** Esegue tutte le attività richieste per tutte le configurazioni del server nelle relative pagine del Rights Management

**Rights Management utente finale:** Può accedere alle pagine Web dell&#39;utente finale del Rights Management

**Rights Management utente invito:** Può invitare gli utenti

**Gestione Rights Management invitati e Utenti locali:** Può eseguire le attività necessarie per gestire tutti gli utenti invitati e locali nelle relative pagine di Rights Management
...
**Amministratore Rights Management:** Esegue tutte le attività richieste dalla pagina del Rights Management

**AEM moduli Amministratore area di lavoro:** Può visualizzare e modificare le impostazioni dalla pagina Area di lavoro nella console di amministrazione
...
**Applicazione Web estensioni Acrobat Reader DC:** Può utilizzare l&#39;applicazione Web con estensione Acrobat Reader DC
...
## Eliminazione di un ruolo {#delete-a-role}
...
**Controllo delle impostazioni di base:** Gestione delle impostazioni nella pagina Impostazioni di sistema di base nella console di amministrazione
...
**Caricamento documento:** Caricare i documenti AEM moduli
...
**PERM_READER_EXTENSIONS_WEB_APPLICATION:** Utilizzare l&#39;applicazione Web con estensione Acrobat Reader DC

**PERM_SP_ADMIN:** Gestione delle impostazioni del connettore SharePoint

**PERM_WORKSPACE_ADMIN:** Gestione impostazioni area di lavoro
...
**Proprietario criterio modifica Rights Management:** Cambia proprietario criterio

**Login console utente finale Rights Management:** Accesso all&#39;interfaccia utente finale del Rights Management

**Configurazione gestione Rights Management:** Gestisci configurazione server

**Gestione Rights Management invitati e Utenti locali:** Gestione degli utenti invitati e locali

**Rights Management Gestisci set di criteri:** Gestisci tutti i criteri e i documenti all&#39;interno di qualsiasi set di criteri

**Coordinatore aggiunta set di criteri di Rights Management:** Aggiunta, rimozione e modifica delle autorizzazioni per i coordinatori di set di criteri

**Rights Management Criteri di creazione set di criteri:** Creare un nuovo criterio per un set di criteri

**Rights Management Criteri di eliminazione set di criteri:** Rimozione di un criterio da un set di criteri

**Rights Management Criteri di modifica set di criteri:** Modificare un criterio in un set di criteri

**Set di criteri di Rights Management Gestisci autore documento:** Quando create dei set di criteri, assegnate agli utenti il ruolo di autore del documento. L&#39;autore del documento è l&#39;utente che protegge il documento con un criterio.

**Rights Management Set Rimuovi Coordinatore:** Rimozione di un coordinatore di set di criteri da un set di criteri

**Rights Management set di criteri Revoca documento:** Revoca dell&#39;accesso ai documenti in un set di criteri

**Criterio switch set di criteri di Rights Management:** Cambiare i criteri per un documento

**Rights Management set di criteri Annulla revoca documento:** Annullamento della revoca di un documento

**Evento visualizzazione set di criteri Rights Management:** Visualizzare gli eventi dei criteri e dei documenti per qualsiasi criterio o documento all&#39;interno di un set di criteri
...
**Attivazione del servizio:** Avviate qualsiasi servizio, rendendolo disponibile per la chiamata
