...
Il percorso predefinito per la directory principale di memorizzazione dei contenuti è *[GDS root]*/lccs_data, dove *[GDS root]* è il percorso descritto in [GDS location](files-back-recover.md#gds-location). Esegui il backup delle seguenti directory che si trovano nella directory principale di Content Storage:
...
Il percorso predefinito per la directory radice dell&#39;indice è *[aem-forms root]*/lucene-index su ciascun nodo.
