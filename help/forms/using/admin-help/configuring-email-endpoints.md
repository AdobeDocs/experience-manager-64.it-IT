...
**Pattern file:** i pattern di allegati che il provider accetta. Questo include file con estensioni specifiche (&amp;ast;.dat, &amp;ast;.xml), nomi specifici (dati) ed espressioni composite nel nome e nell&#39;estensione (.[dD][aA][Tt]). Il valore predefinito è &amp;ast;.&amp;ast;.
...
**Pattern file:** specifica i pattern di allegati che il provider accetta. Questo include file con estensioni specifiche (&amp;ast;.dat, &amp;ast;.xml), nomi specifici (dati) o espressioni composite nel nome e nell&#39;estensione (&amp;ast;.[dD][aA][Tt]).
