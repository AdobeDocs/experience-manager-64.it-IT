...
seo-description: La gestione degli utenti è un componente JEE di AEM Forms che consente di creare, gestire e autorizzare gli utenti AEM Forms ad accedere ad AEM Forms. Approfondisci i dati utente e gli archivi dati. Scopri come accedere e eliminare i dati utente.
...
I dati di gestione degli utenti per gli utenti che hanno effettuato almeno un accesso alle applicazioni Forms in `https://[*server*]:[*host*]/lc` vengono memorizzati anche AEM repository.
