...
AEM Forms è una potente piattaforma di classe enterprise. Il flusso di lavoro Forms-centric su OSGi è solo una delle funzionalità di AEM Forms. Per l&#39;elenco completo delle funzionalità, consulta [Introduzione ad AEM Forms](/help/forms/using/introduction-aem-forms.md).
...
>[!NOTE]
>
>Passa alla sezione [Passaggi successivi](#next-steps) del documento, se hai già installato AEM Forms su OSGi come spiegato nell&#39;articolo [installare e configurare le funzionalità di acquisizione dati](/help/forms/using/installing-configuring-aem-forms-osgi.md) .
