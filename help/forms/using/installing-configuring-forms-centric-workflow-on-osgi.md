...
AEM Forms è una potente piattaforma di classe enterprise. Il flusso di lavoro incentrato sui moduli su OSGi è solo una delle funzionalità di AEM Forms. Per l&#39;elenco completo delle funzionalità, consulta [Introduzione ad AEM Forms](/help/forms/using/introduction-aem-forms.md).

>[!NOTE]
>
>Con il flusso di lavoro incentrato su Forms su OSGi, puoi creare e distribuire rapidamente flussi di lavoro per varie attività sullo stack OSGi, senza dover installare la funzionalità di gestione dei processi completa sullo stack JEE. Per scoprire la differenza e le similarità tra le funzionalità, consulta un [confronto](/help/forms/using/capabilities-osgi-jee-workflows.md) dei flussi di lavoro AEM incentrati su Forms su OSGi e la gestione dei processi su JEE.
>
...
>[!NOTE]
>
>Vai alla sezione [Passaggi successivi](#next-steps) del documento, se hai già installato AEM Forms su OSGi come spiegato nell&#39;articolo [installare e configurare le funzionalità di acquisizione dati](/help/forms/using/installing-configuring-aem-forms-osgi.md) .
...
* [Utilizzo del flusso di lavoro incentrato su Forms su OSGi](/help/forms/using/aem-forms-workflow.md)
