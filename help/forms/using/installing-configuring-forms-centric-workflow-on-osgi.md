...
AEM Forms è una potente piattaforma aziendale. Il flusso di lavoro incentrato sui moduli in OSGi è solo una delle funzionalità di AEM Forms. Per un elenco completo delle funzionalità, consultate [Introduzione ai moduli](/help/forms/using/introduction-aem-forms.md)AEM.
...
>[!NOTE]
>
>Passate alla sezione Passaggi [](#next-steps) successivi del documento, se avete già installato AEM Forms su OSGi come illustrato nell&#39;articolo [Installazione e configurazione delle funzionalità](/help/forms/using/installing-configuring-aem-forms-osgi.md) di acquisizione dei dati.
