...
* [Modelli di modulo](/help/forms/using/creating-adaptive-form.md#p-create-an-adaptive-form-based-on-an-xfa-form-template-p)
...
* [Schema XML](/help/forms/using/creating-adaptive-form.md#p-create-an-adaptive-form-based-on-xml-or-json-schema-p)
...
Vedi [Modello di base di un documento di registrazione](#base-template-of-a-dor)
...
1. Nella sezione Configurazione modello documento della scheda Modello modulo selezionare una delle opzioni seguenti.
   ...
   **[!UICONTROL Selezionare questa opzione per utilizzare un file XDP come modello di base per definire lo stile e l&#39;aspetto del documento di record. Selezionando questa opzione, vengono visualizzati tutti i file XDP disponibili nell’archivio AEM Forms. Selezionare il file appropriato.]**

   **Selezionare Modello Forms come modello di base per generare Documento di record** Selezionare questa opzione per utilizzare un file XDP come modello di base per definire lo stile e l&#39;aspetto del documento di record. Selezionando questa opzione, vengono visualizzati tutti i file XDP disponibili nell’archivio AEM Forms. Selezionare il file appropriato.
...
* il documento di registrazione viene utilizzato solo a scopo di stampa.
