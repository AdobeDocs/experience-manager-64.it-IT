...
1. Per creare una query, fare clic su **Aggiungi** (+).
   ...
   **Definizione di un filtro**
   ...
   1. Per aggiungere un altro filtro alla query, fate clic su **Aggiungi(+)** a destra della riga del filtro.
...
1. Utilizzate le opzioni nell&#39;angolo superiore destro del pannello **Rapporto** per eseguire operazioni sui risultati della query.
...
1. Eseguire una ricerca di processo/attività. Per informazioni dettagliate, vedere [Esecuzione di una query](/help/forms/using/process-reporting/adhoc-queries-in-process-reporting.md#p-to-execute-a-search-query-p)di ricerca dei processi.
