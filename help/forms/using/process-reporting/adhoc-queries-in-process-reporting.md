...
1. Eseguire una ricerca di processo/attività. Per informazioni dettagliate, vedere [Per eseguire una query di ricerca dei processi](/help/forms/using/process-reporting/adhoc-queries-in-process-reporting.md#p-to-execute-a-search-query-p).
