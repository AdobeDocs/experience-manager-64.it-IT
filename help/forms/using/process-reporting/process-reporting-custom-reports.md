...
1. Creare un’interfaccia utente separata come descritto in [Creazione di un’interfaccia utente separata](#creating-a-separate-ui-nbsp) sezione .
...
1. L’interfaccia utente del report è integrata nell’interfaccia utente di Process Reporting. Dopo aver integrato l’interfaccia utente, l’interfaccia utente aggiornata è simile alle seguenti immagini:
   ...
   ![Interfaccia utente dei report personalizzati appena aggiunti](assets/sample-ui-screen-shot-1.png)

   Interfaccia utente dei report personalizzati appena aggiunti

   ![Schermata Risultati dei report personalizzati](assets/jsp-display.png)
