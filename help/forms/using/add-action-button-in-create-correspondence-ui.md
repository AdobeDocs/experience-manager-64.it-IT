...
1. Nella cartella delle app, crea una cartella denominata `defaultApp` con percorso/struttura simile alla cartella defaultApp (che si trova nella cartella di configurazione). Per creare la cartella, effettua le seguenti operazioni:
   ...
   * Fai clic con il pulsante destro del mouse sulla cartella **[!UICONTROL defaultApp]** al seguente percorso e seleziona **[!UICONTROL Sovrapponi nodo]**:
   ...
   * Assicurati che la finestra di dialogo Sovrapponi nodo abbia i seguenti valori:
      ...
      **[!UICONTROL Posizione di sovrapposizione:]** /apps/

      **[!UICONTROL Tipi di nodo di corrispondenza:]** controllati
...
1. Crea una copia del file acmExtensionsConfig.xml (esiste sotto il ramo /libs) sotto il ramo /apps .
   ...
   * Fai clic con il pulsante destro del mouse sulla cartella **[!UICONTROL defaultApp]** in &quot;/apps/fd/cm/config/defaultApp/&quot; e seleziona **[!UICONTROL Incolla]**.
   * Fare clic su **[!UICONTROL Salva tutto]**.
...
1. Fai clic con il pulsante destro del mouse sulla cartella **[!UICONTROL locale]** nel seguente percorso e seleziona **[!UICONTROL Sovrapponi nodo]**:
...
1. Fai clic con il pulsante destro del mouse sulla cartella **[!UICONTROL locale]** nel percorso seguente e seleziona **[!UICONTROL Incolla]**:
...
1. Nella cartella delle app, crea una cartella denominata `js` nel ramo /apps di CRX con struttura simile alla seguente:
   ...
   1. Fai clic con il pulsante destro del mouse sulla cartella **[!UICONTROL js]** al seguente percorso e seleziona **[!UICONTROL Sovrapponi nodo]**:
...
1. Nella cartella js , crea un file denominato ccrcustomization.js con il codice per la gestione dell’azione del pulsante seguendo i passaggi seguenti:
   ...
   1. Fai clic con il pulsante destro del mouse sulla cartella **[!UICONTROL js]** al seguente percorso e seleziona **[!UICONTROL Crea > Crea file]**:
...
### Aggiungi il processo di LiveCycle per abilitare la gestione dell&#39;azione <span class="acrolinxCursorMarker"></span>. {#add-the-livecycle-process-to-enable-action-span-class-acrolinxcursormarker-span-handling}
...
1. Seleziona **[!UICONTROL Distribuisci risorse in fase di esecuzione al termine dell&#39;importazione]**.
...
Per utilizzare l&#39;API di gestione della corrispondenza, scarica il `DSCSample.jar` (allegato in questo documento come parte di `components.zip`) e caricalo sul server di LiveCycle. Dopo il caricamento del file `DSCSample.jar` sul server di LiveCycle, il server AEM utilizza il file `DSCSample.jar` per accedere all’API renderLetter.
...
1. Seleziona **[!UICONTROL Finestra > Mostra visualizzazioni > Componenti]**. La vista Componenti viene aggiunta a Workbench ES2.

1. Fai clic con il pulsante destro del mouse su **[!UICONTROL Componenti]** e seleziona **[!UICONTROL Installa componente]**.

1. Seleziona il file `DSCSample.jar` dal browser dei file e fai clic su **[!UICONTROL Apri]**.
1. Fai clic con il pulsante destro del mouse su **[!UICONTROL RenderWrapper]** e seleziona **[!UICONTROL Avvia componente]**. Se il componente viene avviato, accanto al nome del componente viene visualizzata una freccia verde.
...
1. Nell&#39;interfaccia utente Crea corrispondenza, fai clic su **[!UICONTROL Revisione lettera]** e specifica l&#39;ID e-mail del revisore.
