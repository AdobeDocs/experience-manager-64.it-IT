...
Utilizza [Interfaccia utente di AEM Forms](/help/forms/using/introduction-managing-forms.md) per gestire tutti i moduli, i set di moduli e le relative risorse.
...
Per ulteriori informazioni sull&#39;app AEM Forms, consulta [App AEM Forms](/help/forms/using/aem-forms-app.md).
