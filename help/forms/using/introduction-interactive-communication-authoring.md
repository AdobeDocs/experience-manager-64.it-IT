...
Quando [create una nuova comunicazione o modificate una comunicazione interattiva esistente](/help/forms/using/create-interactive-communication.md), utilizzate i seguenti elementi dell&#39;interfaccia utente:
...
| Tabella | &amp;ast; | AND | Aggiunge una tabella che consente di organizzare i dati in righe e colonne. |
| Area di destinazione | &amp;ast;&amp;ast; | AND | Inserisce un’area di destinazione in un canale Web per organizzare i componenti specifici del canale Web. |
