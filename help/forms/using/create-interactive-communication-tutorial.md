...
Creare una comunicazione interattiva utilizzando tutti i blocchi predefiniti

![personalizzare la comunicazione interattiva](assets/styleaf.png)
...
**Frammenti documento:** [bill_details_first_ic, customer_details_first_ic, bill_summary_first_ic, summary_charge_first_ic](/help/forms/using/create-document-fragments.md)
...
**Modello Web:** [Crea_Primo_IC_Modello_Web](/help/forms/using/create-templates-print-web.md)
...
1. Tocca **Modifica** per aprire la comunicazione interattiva nel riquadro a destra.
1. Esegui i passaggi 6 - 15 di [Creare comunicazioni interattive per il canale di stampa](#create-interactive-communication-for-print-channel) sezione .
...
1. Ripeti i passaggi 13 - 18 di [Creare comunicazioni interattive per il canale web](#create-interactive-communication-for-web-channel) per inserire **Paga ora** e **Abbonati** collegamenti ipertestuali nel canale Web della comunicazione interattiva.
