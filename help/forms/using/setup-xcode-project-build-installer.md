...
1. Fate clic su **AEM Forms**, in **TARGET**, selezionate **AEM Forms**. Selezionate la scheda Impostazioni **** build, individuate la sezione Adesione firma **** codice, quindi nei campi Debug e Rilascio effettuate una delle seguenti operazioni:
   ...
   * Specificate i campi in base a quanto spiegato in [Creazione di un&#39;app AEM Forms  sicura per iOS](/help/forms/using/building-secure-mobile-workspace-app.md) per creare un&#39;app AEM Forms  protetta.
...
1. Nel campo **Titolo** , specificate  AEM Forms.
