...
1. Fare clic sul campo **[!UICONTROL name]** dell&#39;account utente. Viene visualizzata la pagina **[!UICONTROL Edit User Settings]** (Modifica impostazioni utente). Nell&#39;istanza di AEM Author, i certificati risiedono in un KeyStore. Se non avete creato un KeyStore in precedenza, fate clic su **[!UICONTROL Crea KeyStore]** e impostate una nuova password per KeyStore. Se il server contiene già un KeyStore, ignora questo passaggio.  Se utilizzate  certificato Estensioni di Adobe  Reader, la password del file Keystore è sempre la stessa della password della chiave privata.
