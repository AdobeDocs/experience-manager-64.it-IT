...
>[!NOTE]
>
>*Informazioni su  Amazon SNS e un collegamento per la creazione di un nuovo account AWS sono disponibili[qui](https://aws.amazon.com/sns/). Potete ottenere un account gratuito per un anno.*
...
1. **Crea chiave di accesso e ID**
   ...
   1. Fate clic su **Mostra chiave** di accesso, quindi copiate e salvate l&#39;ID chiave di accesso e la chiave di accesso segreta mostrati. Se scegliete l&#39;opzione per scaricare le chiavi, otterrete un file CSV che contiene gli stessi valori.
...
1. **Creare un pool di identità**
   ...
   1. Utilizzate [Cognito](https://console.aws.amazon.com/cognito) per creare un pool di identità, che memorizzerà i dati di base degli utenti non autenticati. In questa fase, solo le regioni &quot;us-east&quot; e &quot;eu&quot; sono supportate da  Amazon Cognito.
...
### Passaggio 5: Configurare il push su AEM app {#step-configure-push-on-aem-apps}
...
1. *PhoneGap Build* è un servizio offerto da PhoneGap che creerà la vostra app per voi sui loro server, e vi permetterà di scaricarla direttamente sul vostro dispositivo. Per informazioni su come impostare e utilizzare le PhoneGap Build, fare riferimento alla documentazione [relativa alle](https://build.phonegap.com/) PhoneGap Build.

1. *L&#39;interfaccia* CLI (Command Line Interface) di PhoneGap consente di utilizzare un set completo di comandi PhoneGap sulla riga di comando per creare, eseguire il debug e distribuire l&#39;app. Per informazioni su come impostare e utilizzare l&#39;interfaccia CLI di PhoneGap, fare riferimento alla documentazione [per gli sviluppatori di](https://docs.phonegap.com/en/edge/guide_cli_index.md.html#The%20Command-Line%20Interface) PhoneGap.
...
Una volta inclusi i dettagli sulle notifiche push per la tua app, consulta [AEM Mobile Content Personalization](/help/mobile/phonegap-aem-mobile-content-personalization.md)(Personalizzazione dei contenuti).
