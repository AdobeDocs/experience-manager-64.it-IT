...
1. [AEM 6.4](https://helpx.adobe.com/experience-manager/6-4/release-notes.html) o [AEM 6.3](https://helpx.adobe.com/experience-manager/6-3/release-notes.html) + Feature Pack per schermi più recenti
...
I passaggi dell&#39;esercitazione e le schermate vengono eseguiti utilizzando [CRXDE-Lite](http://localhost:4502/crx/de/index.jsp). [Per completare l’esercitazione è inoltre possibile utilizzare IDE Eclipse](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/aem-eclipse.html) o [IntelliJ](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/ht-intellij.html) . Ulteriori informazioni sull’utilizzo di un IDE per lo sviluppo [con AEM sono disponibili qui.](https://helpx.adobe.com/experience-manager/kt/sites/using/getting-started-wknd-tutorial-develop/part1.html#eclipse-ide)

>[!NOTE]
>
>Prima di iniziare questa esercitazione, si consiglia di aver rivisto quanto segue:
>
>1. [Informazioni su AEM Screens](https://helpx.adobe.com/experience-manager/kt/screens/using/screens-concepts-feature-video-understand.html)
>1. [Guida Kickstart per schermi](https://helpx.adobe.com/experience-manager/6-4/sites/deploying/using/kickstart-for-aem-screens.html)
>
...
1. Creare un file sotto `/apps/weretail-run/components/content/helloworld` nome `edit.html.`
   ...
   */-->
   ...
   Sopra è riportata la marcatura di modifica per il componente Hello World. Il primo blocco visualizza una versione di modifica del componente se il messaggio della finestra di dialogo è stato compilato.
...
1. **Aggiorna Hello World per includere una scheda per il messaggio.**
...
Il rendering dei componenti AEM Screens varia in modalità Modifica rispetto alla modalità Anteprima/Produzione. Verranno create due librerie client, una per la modalità di modifica e una per l&#39;anteprima/produzione.
...
1. Aggiungete le seguenti proprietà alla libreria client condivisa:
   ...
   * `categories`| Stringa[] | `cq.screens.components`
   ...
   È consigliabile non esporre mai alcun percorso direttamente alle /app in un ambiente di produzione. La proprietà allowProxy assicura che alla libreria client venga fatto riferimento CSS e JS tramite un prefisso of/etc.clientlibs. Ulteriori informazioni sulla proprietà [allowProxy sono disponibili qui.](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/clientlibs.html#main-pars_title_8ced)
...
1. In [CRXDE-Lite](http://localhost:4502/crx/de/index.jsp#/apps/settings/wcm/designs) andate a `/apps/settings/wcm/designs`
...
1. Passaggio modello - scegliere** Canale sequenza**
...
1. Passate alla modalità **Modifica** pagina. È ora possibile aggiungere il componente Hello World alla pagina e combinarlo con altri componenti per canali di sequenza.
