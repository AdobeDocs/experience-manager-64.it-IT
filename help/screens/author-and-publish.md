...
### Impostazione degli agenti di replica in Author {#setting-up-replication-agents-on-author}
...
Seguire gli stessi passaggi per creare un agente di replica inversa.
...
1. Andate a https://&lt;host>:&lt;porta>/system/console/configMgr
1. Selezionate **Apache Sling Oak-Based Discovery Service** Configuration.
1. Aggiorna URL connettore topologia: aggiungete URL di tutte le istanze di pubblicazione partizionate, ossia [http://localhost:4502/libs/sling/topology/connector](http://localhost:4502/libs/sling/topology/connector)
...
Per una qualsiasi delle istanze Pubblica, andate a https://&lt;host>:&lt;porta>/system/console/topologia. Dovreste visualizzare ogni istanza di pubblicazione rappresentata nella topologia.
...
Pub2 - {8d3d113c834cc4f52c2date0da3cb0a21122a31f0138bfe4b70c9ead79415f41}
...
1. Andate alla console OSGi -> Principale > ActiveMQ Artemis ([http://localhost:4505/system/console/mq](http://localhost:4505/system/console/mq)).
...
1. Andate a **Configuration Manager** dalla console **** OSGi.
1. Selezionate **Filtro** di riferimento Apache Sling.
1. Aggiorna configurazione e **seleziona Consenti valori nulli**.
...
1. Andate a [http://localhost:4502/screens.html/content/screens/we-retail](http://localhost:4502/screens.html/content/screens/we-retail) o selezionate il progetto e andate a Dispositivi > Gestione dispositivi.
...
1. Passate alla pagina di amministrazione dell’utente (ad esempio: [http://localhost:4502/useradmin](http://localhost:4502/useradmin)).
...
1. Fare clic sull&#39;opzione **Configuration **dal pannello laterale.
...
1. Fate clic su **Pubblica** nella procedura guidata **Gestisci **pubblicazione**.
