...
* Documentazione, basata direttamente sulla [lista](/help/managing/best-practices-checklist.md)di controllo, che descrive:
   ...
   * [Analisi Heartbeat](#project-heartbeat-dashboard) progetto.
...
* Documentazione di AEM
   ...
   Inoltre, le seguenti sezioni della documentazione AEM sono di particolare interesse (questo elenco non è esaustivo):
