...
* Documentazione, basata direttamente sulla [checklist](/help/managing/best-practices-checklist.md), che descrive in dettaglio:
   ...
   * [Progetto ](#project-heartbeat-dashboard) Heartbeatanalysis.
...
Il foglio di lavoro **Stato per ruolo** mostra una suddivisione dettagliata di **[Salute, Qualità e Completezza](#project-heartbeat-dashboard)** di **[Fase](#phases-and-milestones)** e **[Persona](#persona)**.
