...
* **operation**
   ...
   &quot; `=`&quot; per corrispondenza esatta, &quot; `!=`&quot; per confronto di disuguaglianza, &quot; `>`&quot; per la proprietà1 maggiore di property2, &quot; `>=`&quot; per la proprietà1 maggiore o uguale a property2. Il valore predefinito è &quot; `=`&quot;.
...
Limita il risultato agli elementi in cui la sessione corrente dispone dei privilegi [JCR](https://www.adobe.io/experience-manager/reference-materials/spec/jcr/2.0/16_Access_Control_Management.html#16.2.3%20Standard%20Privileges) specificati.
...
Trova gli elementi che sono membri di una [raccolta di risorse sling](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/org/apache/sling/resource/collection/ResourceCollection.html) specifica.
