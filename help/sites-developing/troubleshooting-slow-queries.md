...
1. ***Questa regolazione è specifica di Query Builder e non si applica a JCR-SQL2 o XPath.***
   ...
   Utilizzare [Query Builder&#39;, ad esempio, il valore relativo alla somma totale dei risultati **not **immediatamente necessario.](/help/sites-developing/querybuilder-api.md#using-p-guesstotal-to-return-the-results)
