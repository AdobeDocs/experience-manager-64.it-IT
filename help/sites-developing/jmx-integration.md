...
Utilizzate BundleContext per registrare l&#39;MBean come servizio OSGi. Includere le informazioni relative a JMX nell&#39;oggetto Dictionary utilizzato come argomento del `BundleContext.registerService` metodo.
...
>[!NOTE]
>
> Per semplicità, il codice di questo esempio non esegue la registrazione o reagisce alle eccezioni generate.
