...
Al momento dell&#39;authoring, 5.5.2 è la versione del bundle API WCM Mobile che si trova nell&#39;ultima versione di AEM. Utilizzate  console Web di Adobe ([http://localhost:4502/system/console/bundles](http://localhost:4502/system/console/bundles)) per verificare che si tratti della versione del bundle distribuita nell&#39;ambiente in uso.
