...
* [Aprire il progetto demo aem-uberjar su GitHub](https://github.com/justinedelson/aem-uberjar-demo)
* Scarica il progetto come [file ZIP](https://github.com/justinedelson/aem-uberjar-demo/archive/6.2-unobfuscated.zip)

>[!NOTE]
>
>È anche possibile configurare questi repository nel file Maven *settings.xml* .

Gli utenti di altri sistemi di build (ad esempio, Apache Ant, Gradle) devono seguire una procedura simile, adattata alla sintassi specifica del loro strumento scelto.
...
### Come lavorare con JSP {#how-to-work-with-jsps}
