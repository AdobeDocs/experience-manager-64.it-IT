...
>[!NOTE]
>
>La funzione Editor applicazione per pagina singola (SPA) richiede [AEM 6.4 Service Pack 2](/help/release-notes/sp-release-notes.md) o successivo.
>
...
AEM SPA Editor SDK è stato introdotto con AEM 6.4 service pack 2. È completamente supportato da Adobe, e come nuova funzione continua ad essere migliorato ed espanso. Le seguenti funzioni di AEM non sono ancora coperte dall’editor SPA:
