...
* **`LiveRelationship`** La `LiveRelationship` specifica la connessione (relazione) tra una risorsa nel ramo Live Copy e la relativa risorsa sorgente/blueprint equivalente.
...
1. Ripeti il passaggio precedente per creare il `/apps/wcm/core` struttura delle cartelle. Crea un nodo di tipo `sling:Folder` nel nucleo chiamato `resources`. <!-- ![chlimage_1-39](assets/chlimage_1-39.png) -->
