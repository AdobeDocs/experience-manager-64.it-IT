...
Per informazioni complete, inclusi gli attributi per filtrare JS, CSS o librerie di temi, vedi [ui:includeClientLib](/help/sites-developing/taglib.md#amp-lt-ui-includeclientlib).

>[!CAUTION]
>
>`<cq:includeClientLib>`, che in passato veniva comunemente utilizzato per includere le librerie client, è stato dichiarato obsoleto a partire dalla AEM 5.6. [ `<ui:includeClientLib>`](/help/sites-developing/taglib.md#amp-lt-ui-includeclientlib) devono essere utilizzati come descritto in precedenza.
...
1. Apri CRXDE Lite in un browser Web ([http://localhost:4502/crx/de](http://localhost:4502/crx/de)).
...
1. Vai a Apache Felix Config Manager in [http://localhost:4502/system/console/configMgr](http://localhost:4502/system/console/configMgr)
...
Per informazioni sulla configurazione del servizio, vedi [AEM HTML Library Manager](/help/sites-deploying/osgi-configuration-settings.md).
