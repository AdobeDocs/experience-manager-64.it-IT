...
La `com.day.cq.wcm.foundation.impl.AdaptiveImageComponentServlet` classe estende la classe [AbstractImageServlet](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/commons/AbstractImageServlet.html) . Il codice sorgente AdaptiveImageComponentServlet si trova nella `/libs/foundation/src/impl/src/com/day/cq/wcm/foundation/impl` cartella.
...
>[!NOTE]
>
>La classe [com.day.cq.commons.DownloadResource](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/commons/DownloadResource.html) fornisce il `getFileReference method`, che recupera il valore della `fileReference` proprietà della risorsa.
...
La classe info.geometrixx.commons.impl.servlets.ImageReferenceModificationServlet estende la classe [AbstractImageServlet](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/commons/AbstractImageServlet.html) . Se avete installato il pacchetto cq-geometrixx-commons-pkg, il codice sorgente ImageReferenceModificationServlet si trova nella `/apps/geometrixx-commons/src/core/src/main/java/info/geometrixx/commons/impl/servlets` cartella.
...
La `ImageReferenceModificationServlet` classe sostituisce il `createLayer` metodo e implementa la logica che determina la risorsa immagine da eseguire. Il metodo recupera un nodo secondario del `jcr:content` nodo della pagina denominato `image`. Da questo [nodo viene creato un oggetto](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/foundation/Image.html) Immagine `image` e il `getFileReference` metodo restituisce il percorso del file immagine dalla `fileReference` proprietà del nodo immagine.

>[!NOTE]
>
>La classe [com.day.cq.commons.DownloadResource](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/commons/DownloadResource.html) fornisce il metodo getFileReference.
