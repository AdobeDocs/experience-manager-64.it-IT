...
All’interno di Adobe Analytics sono disponibili una serie di variabili predefinite configurabili in un framework**. **Le variabili **charset**, **cookieLifetime**, **currencyCode** e **trackInlineStats** sono incluse per impostazione predefinita nell&#39;elenco **Impostazioni generali di Analytics**.
