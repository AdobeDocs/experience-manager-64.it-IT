...
Qui puoi [modificare e gestire](/help/assets/content-fragments.md) il frammento utilizzando le schede (pannello a sinistra):

![](do-not-localize/cf-45-aa.png) ![](do-not-localize/cf-45-a.png)

* **[](/help/assets/content-fragments-variations.md)** Varianti, tra cui  [Markdown](/help/assets/content-fragments-markdown.md)
