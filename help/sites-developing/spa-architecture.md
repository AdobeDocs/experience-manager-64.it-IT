...
* **[Routing dinamico](#dynamic-routing) -** Il SPA è responsabile dell’indirizzamento e AEM lo ascolta e recupera i dati del componente in base ad esso. Anche qualsiasi indirizzamento deve essere dinamico.
