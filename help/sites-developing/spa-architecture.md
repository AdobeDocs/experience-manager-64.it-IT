...
seo-description: Questo articolo presenta domande importanti da tenere in considerazione quando uno sviluppatore front-end si impegna a sviluppare una SPA per AEM e fornisce una panoramica dell'architettura di AEM rispetto alle SPA da tenere presente quando si implementa una SPA sviluppata su AEM.
...
* **[Routing](#dynamic-routing)dinamico -**L&#39;SPA è responsabile del routing e AEM riceve i dati dei componenti in base ad esso. Anche l&#39;indirizzamento deve essere dinamico.
...
Se non è necessario supportare AEM funzioni di authoring, potrebbe essere necessario considerare un diverso modello [di progettazione](/help/sites-developing/spa-architecture.md#spa-design-models)SPA.
...
Come per il rendering, anche tutti i routing devono essere dinamici. In AEM, [l&#39;SPA deve sempre possedere l&#39;indirizzamento](/help/sites-developing/spa-routing.md) e AEM ascoltare e recuperare il contenuto in base ad esso.
...
Se [vengono seguiti i principi dello sviluppo di SPA in AEM](/help/sites-developing/spa-architecture.md#spa-development-principles-for-aem) , l&#39;SPA funzionerà con tutte le funzioni AEM di authoring dei contenuti supportate.
...
<table> 
 <tbody>
  ...
  <tr>
   <td>AEM viene utilizzato come CMS headless senza utilizzare il framework SDK <a href="/help/sites-developing/spa-reference-materials.md">SPA Editor.</a></td> 
...
>[!NOTE]
>
>Anche se tutti i modelli sono supportati in AEM, solo implementando il terzo (e quindi seguendo i principi di sviluppo [SPA consigliati in AEM](/help/sites-developing/spa-architecture.md#spa-development-principles-for-aem)) gli autori dei contenuti potranno interagire con e modificare il contenuto dell&#39;SPA in AEM come sono abituati.

## Migrazione di SPA esistenti a AEM {#migrating-existing-spas-to-aem}

In genere, se l&#39;SPA segue i principi di sviluppo dell&#39; [SPA per AEM](/help/sites-developing/spa-architecture.md#spa-development-principles-for-aem), l&#39;SPA lavorerà in AEM e sarà modificabile utilizzando AEM SPA Editor.
...
Il compito principale nell&#39;affidare a uno sviluppatore front-end la creazione di una SPA per AEM è quello di concordare i componenti e i relativi modelli JSON.
...
* [Guida introduttiva alle app SPA in AEM - React](/help/sites-developing/spa-getting-started-react.md)
...
Per una panoramica di come è strutturata una semplice SPA in AEM e come funziona, consultate la guida introduttiva per [React](/help/sites-developing/spa-getting-started-react.md) e [Angular](/help/sites-developing/spa-getting-started-angular.md).
