...
>[!NOTE]
>
>È disponibile un articolo AEM della community che spiega come sviluppare un sito di Experience Manager con modelli modificabili, consulta [Creazione di un sito web Adobe Experience Manager 6.4 utilizzando i modelli modificabili](https://helpx.adobe.com/experience-manager/using/first_aem64_website.html).
...
>[!NOTE]
>
>A partire dalla AEM 6.4, l’utilizzo di modelli statici non è considerata una best practice. In alternativa, utilizza i modelli modificabili .
>
