...
1. Selezionate un componente di intestazione e osservate che la barra degli strumenti è simile a quella di qualsiasi altro componente. Seleziona **[!UICONTROL Modifica]**.
...
1. Caricate l&#39;applicazione We.Retail Journal sul server di pubblicazione o utilizzando l&#39;opzione **[!UICONTROL Visualizza come pubblicato]** dal menu **Informazioni pagina** nell&#39;editor pagina.
...
1. Se non è già stato caricato, caricate l&#39;applicazione We.Retail Journal sul server di pubblicazione o utilizzando l&#39;opzione **[!UICONTROL Visualizza come pubblicato]** dal menu **Informazioni pagina** nell&#39;editor pagina.
...
1. Caricate la `react.model.json` in una nuova scheda.
   ...
   L&#39;editor SPA AEM utilizza [AEM Content Services](/help/assets/content-fragments.md) per distribuire l&#39;intero contenuto della pagina come modello JSON.
