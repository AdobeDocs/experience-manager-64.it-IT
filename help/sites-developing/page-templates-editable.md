...
1. Configura la struttura, i criteri dei contenuti, il contenuto iniziale e il layout del nuovo modello.
   ...
   * Sono applicabili al modello (e alle pagine create con il modello).
   ...
   Per informazioni tecniche sulle politiche, consulta [Criteri di contenuto](/help/sites-developing/page-templates-editable.md#content-policies) in questo documento.
...
Vengono memorizzate le definizioni dei modelli modificabili [cartelle definite dall&#39;utente](/help/sites-developing/page-templates-editable.md#template-folders) (consigliato) o in alternativa in `global`. Ad esempio:
...
1. **Attiva il modello**
   ...
   * [Abilitazione del modello](/help/sites-authoring/templates.md#enabling-and-allowing-a-template-template-author) dal **Modelli** console.
...
1. **Modelli consentiti**
   ...
   * Imposta la proprietà:
      ...
      Sulla `jcr:content` nodo del ramo richiesto.
...
* Modello - Bundle OSGi
   ...
   La [Bundle OSGI](/help/sites-deploying/osgi-configuration-settings.md) implementa la funzionalità .
