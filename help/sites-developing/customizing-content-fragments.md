...
* [Creazione e gestione di frammenti di contenuto](/help/assets/content-fragments.md) e [Authoring delle pagine con frammenti di contenuto](/help/sites-authoring/content-fragments.md) per ulteriori informazioni sui frammenti di contenuto.
...
Le basi [parti costituenti](/help/assets/content-fragments.md#constituent-parts-of-a-content-fragment) di un frammento di contenuto:
...
Per maggiori dettagli vedi [Frammento di contenuto - Considerazioni sull’eliminazione](/help/assets/content-fragments-delete.md).
...
I parametri di questo possono essere configurati nel [Console web](/help/sites-deploying/configuring-osgi.md#osgi-configuration-with-the-web-console), per il bundle OSGi **Configurazione dei frammenti di contenuto DAM**.
...
* **Frammento di contenuto**
   ...
   <pre><a href="https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/adobe/cq/dam/cfm/ContentFragment.html">Frammento di contenuto</a></pre>
