...
>* Consultate il [webinar Ask the AEM Experts on Workflows (Chiedi agli esperti sui flussi di lavoro)](https://bit.ly/ATACE218).
...
>* Modifiche alle posizioni delle informazioni vedere Ristrutturazione [repository in AEM 6.4](/help/sites-deploying/repository-restructuring.md) e Best practice per i [flussi di lavoro - Ubicazione](/help/sites-developing/workflows-best-practices.md#locations).
...
In genere, i flussi di lavoro vengono utilizzati per elaborare gli invii di moduli in AEM. Questo può essere possibile con i componenti [core dei componenti](https://helpx.adobe.com/experience-manager/core-components/using/form-container.html) modulo disponibili in un&#39;istanza AEM standard o con la soluzione [AEM Forms](/help/forms/using/aem-forms-workflow.md).
