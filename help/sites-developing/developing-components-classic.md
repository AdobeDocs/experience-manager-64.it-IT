...
>
>HTL è ora il linguaggio di script consigliato per AEM. Vedi [HTL](https://helpx.adobe.com/experience-manager/htl/user-guide.html) e [Sviluppo di componenti AEM](/help/sites-developing/developing-components.md) per confrontare i metodi.
...
* Tramite il `currentPage` oggetto introdotto in `global.jsp`:
   ...
   La `currentPage` l&#39;oggetto è un&#39;istanza di una pagina (vedi [API AEM](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/api/Page.mhtml)). La classe page fornisce alcuni metodi per accedere al contenuto.
...
1. Apri la nuova cartella dei componenti e apporta le modifiche necessarie. Inoltre, elimina eventuali informazioni estranee presenti nella cartella.
   ...
   * o rielaborazione completa dell’intero componente, se lo si desidera
   ...
   >Un componente per:
   >
   >* L’interfaccia touch utilizza [Granite](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/granite-ui/api/jcr_root/libs/granite/ui/index.html) componenti
