...
Per abilitare un modello esistente per il sito Web e visualizzarlo nella finestra di dialogo **Crea pagina** quando crei una pagina in **Siti** Web dalla console Siti **Web** , imposta la proprietà allowPaths del nodo del modello su: **/content(/.&amp;ast;)?**
...
1. Copiare un modello esistente (preferibilmente con una definizione il più vicino possibile a quello che si desidera ottenere) in un nuovo nodo.
   ...
   >[!NOTE]
   >
   >L’elenco dei modelli disponibili dipende dalla posizione della nuova pagina e dalle limitazioni alla posizione specificate in ciascun modello. Consulta Disponibilità [dei](/help/sites-developing/templates.md#template-availability)modelli.
