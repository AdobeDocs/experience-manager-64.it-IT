...
1. Inserisci i dati dell’indirizzo appropriati, quindi fai clic su **Salva** per salvare il lead. Per aggiungere altri lead, fate clic su** Salva e nuovo**.
...
1. Inserisci le informazioni come descritto nei dati esemplificativi. È possibile importare i seguenti campi: email,familyName,givenName,gender,aboutMe,city,country,phoneNumber,postalCode,region,streetAddress
...
1. Nel menu **Strumenti**, seleziona **Aggiungi all’elenco.** Si apre la finestra **Add to List **.
