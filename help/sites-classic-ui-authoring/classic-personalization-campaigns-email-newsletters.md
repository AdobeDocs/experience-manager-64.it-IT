...
1. nAdd the component **Text &amp; Personalization** from the sidekick. Questo componente è la parte del gruppo newsletter. Apri questo componente nella modalità di modifica.
