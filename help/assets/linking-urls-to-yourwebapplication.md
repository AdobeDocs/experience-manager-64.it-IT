...
seo-description: Come collegare gli URL all’applicazione Web in contenuti multimediali dinamici
...
Vedere anche [Caricamento delle risorse.](managing-assets-touch-ui.md#uploading-assets)
...
1. Per ottenere l’URL della risorsa statica pubblicata, usate uno dei seguenti metodi:
   ...
   * fate clic su **[!UICONTROL Risorse > Rendering dinamici]**, quindi toccate un rendering dinamico della risorsa statica e copiate l&#39;URL.
...
1. Vicino all&#39;angolo superiore sinistro della pagina, toccare **[!UICONTROL Cloud Service]s**, quindi toccare l&#39;icona AEM e passare a **[!UICONTROL Generale > CRXDE Lite]**.
