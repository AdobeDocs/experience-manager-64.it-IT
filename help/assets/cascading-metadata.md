...
1. (Facoltativo) Nell’editor dello schema di metadati, create un nuovo campo da personalizzare. Specificare un nome e un percorso di proprietà nella scheda **[!UICONTROL Impostazioni]**.
   ...
   Per creare una nuova scheda, toccate o fate clic su **[!UICONTROL +]** per aggiungere una scheda, quindi aggiungete un campo di metadati.
...
1. Ripetete i passaggi per creare una dipendenza tra le risorse del documento (PDF e Word) nel campo **[!UICONTROL Tipo risorsa]** e nei campi quali Conteggio pagina e Autore.
