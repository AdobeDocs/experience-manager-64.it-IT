...
>[!NOTE]
>
>Applicabile a Contenuti multimediali *dinamici - Modalità* Scene7 solo in AEM 6.4.7.0 o versioni successive.
...
>[!NOTE]
>
>Se state eseguendo una migrazione di massa di risorse da Dynamic Media Classic ad AEM, dovete attivare l’agente di replica della migrazione sul server Dynamic Media. Al termine della migrazione, accertatevi di disabilitare l’agente. L’agente di pubblicazione della migrazione deve essere disabilitato sul server di contenuti multimediali dinamici, in modo che il flusso di lavoro di rielaborazione funzioni come previsto.
