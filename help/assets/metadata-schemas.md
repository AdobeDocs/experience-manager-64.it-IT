...
## Aggiungere un modulo di schema di metadati {#adding-a-metadata-schema-form}
...
1. Nella pagina **[!UICONTROL Schema Forms]** selezionare la casella di controllo prima di un modulo, quindi fare clic su **[!UICONTROL Modifica]** sulla barra degli strumenti.
...
La funzione dello schema di metadati è disponibile solo per gli amministratori. Tuttavia, gli amministratori possono fornire l&#39;accesso agli utenti non amministratori fornendo le autorizzazioni **[!UICONTROL Create]**, **[!UICONTROL Modify]** e **[!UICONTROL Delete]** nella cartella `/conf`.

## Applica metadati specifici per le cartelle {#applying-folder-specific-metadata}
...
1. Se alla cartella è applicato un altro schema di metadati, viene visualizzato un messaggio di avviso che informa che lo schema di metadati esistente sta per essere sovrascritto. Fare clic su **[!UICONTROL Sovrascrivi]**.
1. Fare clic su **[!UICONTROL OK]** per chiudere il messaggio di riuscita.
...
1. Fai clic su **[!UICONTROL Salva]**. Il modulo modificato è elencato nella pagina **[!UICONTROL Schema metadati Forms]**. Per applicare i metadati personalizzati a una cartella, selezionate il modulo e toccate o fate clic su **[!UICONTROL Applica alle cartelle]** nella barra degli strumenti.
...
1. (Facoltativo) Accedere a `http://[server]:[port]/system/console/components/`. Configura e abilita il componente `com.day.cq.dam.core.impl.MissingMetadataNotificationJob` disabilitato per impostazione predefinita. Impostate la frequenza con cui AEM verifica la validità dei metadati sulle risorse.
