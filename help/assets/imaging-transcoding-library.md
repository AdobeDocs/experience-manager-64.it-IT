...
1. Aggiungere `/aem64/author/crx-quickstart/launchpad/felix/bundle<id>/data/binaries/` il percorso al file conf utilizzando `cat SWitchEngineLibs.conf` il comando.
