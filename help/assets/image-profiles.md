...
## Modifica o eliminazione dei profili immagine Dynamic Media {#editing-or-deleting-image-profiles}
...
Quando aggiungete un ritaglio avanzato a un profilo di immagine esistente, dovete attivare nuovamente il flusso di lavoro [Aggiornamento risorsa DAM](assets-workflow.md) per generare i raccolti per le risorse esistenti nell’archivio delle risorse.
