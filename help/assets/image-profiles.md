...
seo-title: Profili immagine Dynamic Media
...
seo-description: Crea profili immagine contenenti impostazioni per maschera non affilata, ritaglio avanzato, campione avanzato o entrambi, quindi applica il profilo a una cartella di risorse immagine.
...
Quando aggiungi il ritaglio avanzato a un profilo immagine esistente, devi riattivare il flusso di lavoro [Aggiorna risorsa DAM](assets-workflow.md) se desideri generare i raccolti per le risorse esistenti nell’archivio risorse.
...
1. Effettua una delle operazioni seguenti:
   ...
   * Passa a **https://&lt;AEM server>/mnt/overlay/dam/gui/content/assets/foldersharewizard.html/content/dam** e applica il profilo appropriato, quindi tocca **Salva**.
...
1. Vicino all’angolo superiore destro della pagina, tocca **[!UICONTROL Salva]**. quindi tocca **[!UICONTROL Chiudi]** per tornare alla cartella delle risorse.
