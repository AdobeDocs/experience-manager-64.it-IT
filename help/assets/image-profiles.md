...
You use **Unsharp Mask** to fine-tune a sharpening filter effect on the final downsampled image. Puoi controllare l’intensità dell’effetto, il raggio in pixel e una soglia di contrasto da ignorare. L’effetto utilizza le stesse opzioni del filtro “Maschera definizione dettagli” di Adobe Photoshop.
...
La nitidezza è descritta in [Immagini](/help/assets/assets/s7_sharpening_images.pdf)di nitidezza.
...
**Per creare profili** immagine per elementi multimediali dinamici:
...
1. Effettua una delle operazioni seguenti:
   ...
   * Andate a **https://&lt;server AEM>/mnt/overlay/dam/gui/content/assets/foldersharewizard.html/content/dam** e applicate il profilo appropriato, quindi toccate **Salva**.
