...
seo-description: L'imaging intelligente sfrutta le caratteristiche di visualizzazione esclusive di ogni utente per fornire automaticamente le immagini giuste ottimizzate per la propria esperienza, migliorando le prestazioni e il coinvolgimento.
...
|---|---|---|---|---|
| [Immagine 1](https://techsupport.scene7.com/is/image/TechSupport/SmartImaging_6?hei=500&amp;fmt=jpg&amp;qlt=85&amp;resmode=bisharp&amp;op_usm=5,0.125,5,0) | ![picture1](assets-dm/picture1.png) | 73.75 KB | 45.92 KB | 38% |
| [Immagine 2](https://techsupport.scene7.com/is/image/TechSupport/SmartImaging_3?hei=500&amp;fmt=jpg&amp;qlt=85&amp;resmode=bisharp&amp;op_usm=5,0.125,5,0) | ![picture2](assets-dm/picture2.png) | 191 KB | 70.66 KB | 63% |
| [Immagine 3](https://techsupport.scene7.com/is/image/TechSupport/SmartImaging_2?hei=500&amp;fmt=jpg&amp;qlt=85&amp;resmode=bisharp&amp;op_usm=5,0.125,5,0) | ![picture3](assets-dm/picture3.png) | 96.64 KB | 39.44 KB | 59% |
...
No. La funzione Smart imaging è inclusa nella licenza esistente di Dynamic Media Classic o Adobe Experience Manager - Dynamic Media (On-Prem, AMS e Experience Manager as a Cloud Service).
...
Smart imaging funziona con i &quot;predefiniti immagine&quot; esistenti ed osserva tutte le impostazioni dell&#39;immagine eccetto la qualità (`qlt`) e il formato (`fmt`) se il formato file richiesto è JPEG o PNG. Per la conversione del formato, l&#39;Adobe mantiene la fedeltà visiva completa come definito dalle impostazioni del predefinito per immagini, ma con dimensioni file inferiori. Se le dimensioni originali dell&#39;immagine sono inferiori a quelle prodotte da Smart imaging, l&#39;immagine originale viene servita.
...
>[!NOTE]
>
>Non tutte le immagini vengono convertite. L’imaging intelligente determina se la conversione migliora le prestazioni. A volte, quando non si prevede alcun guadagno di prestazioni o il formato non è JPEG o PNG, l&#39;immagine non viene convertita.
