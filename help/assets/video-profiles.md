...
>
>I metadati sono utili per la ricerca delle risorse. Le miniature sono immagini video statiche generate durante la codifica. Sono richiesti dal sistema AEM e sono utilizzati nell’interfaccia utente per identificare visivamente i video nelle viste **[!UICONTROL Schede]**, Risultati **** ricerca e Elenco **** risorse. Potete visualizzare le miniature generate toccando l&#39;icona **[!UICONTROL Rappresentazioni]** (la palette del pittore) di un video codificato.
...
Al termine, il profilo video viene applicato a una o più cartelle.
...
1. Dalla pagina **[!UICONTROL CRXDE Lite]** , nel pannello **[!UICONTROL Explorer]** a sinistra, andate a:
...
1. Nell’angolo in alto a sinistra della pagina **[!UICONTROL CRXDE Lite]** , toccate l’icona **[!UICONTROL Indietro Home]** per tornare ad AEM.
...
1. Toccate il logo AEM e andate a **[!UICONTROL Risorse]** , quindi alla cartella a cui desiderate applicare un profilo video.
...
1. Toccate il logo AEM, selezionate **[!UICONTROL Risorse]** e quindi la cartella da cui desiderate rimuovere un profilo video.
1. Sulla cartella, toccate il segno di spunta per selezionarlo, quindi toccate **[!UICONTROL Proprietà]**.
