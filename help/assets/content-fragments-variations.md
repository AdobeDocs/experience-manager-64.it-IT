...
[](content-fragments.md#constituent-parts-of-a-content-fragment) Le varianti sono una caratteristica significativa dei frammenti di contenuto, in quanto consentono di creare e modificare copie del contenuto principale da utilizzare su canali e/o scenari specifici.
...
* [Testo riepilogo](#summarizing-text)
* [](content-fragments-variations.md#annotating-a-content-fragment) Annotazione del testo
...
1. Seleziona **[!UICONTROL Riepiloga testo]** dalla barra degli strumenti.

   ![cf-17](assets/cf-17.png)

1. Specifica il numero di parole desiderato e seleziona **[!UICONTROL Start]**:
...
1. Seleziona **[!UICONTROL Riepilogo]** per confermare le modifiche.
...
1. Selezionare **[!UICONTROL Master]** o la variante richiesta.
1. Apri l’editor a schermo intero.
1. Seleziona del testo. L&#39;icona **[!UICONTROL Annota]** diventa disponibile.
...
* Può essere elencato ed eliminato selezionando la scheda **[!UICONTROL Annotazioni]** nell’editor frammenti.
...
Per semplificare il processo di creazione dei frammenti di contenuto, puoi aggiungere direttamente [Risorse](managing-assets-touch-ui.md) (immagini) al frammento.
...
1. Seleziona **[!UICONTROL Variazioni]** dalla barra delle icone nel pannello laterale.
...
1. Apri il frammento e seleziona **[!UICONTROL Variazioni]** dal pannello laterale.
...
1. Conferma l’azione **[!UICONTROL Elimina]** nella finestra di dialogo.
...
2. Seleziona una variante specifica, quindi l’azione di sincronizzazione appropriata da:
...
3. Master e la variante saranno mostrati uno accanto all’altro:
...
4. Seleziona **[!UICONTROL Sincronizza]**, la variante verrà aggiornata e visualizzata.
