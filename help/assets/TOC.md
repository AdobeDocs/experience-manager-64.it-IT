...
+ Amministrazione delle risorse {#administer}
   ...
   + [Best practice per la condivisione di cartelle da AEM a Creative Cloud](aem-cc-folder-sharing-best-practices.md)
...
+ Manage Assets {#managing}
   ...
   + [Ordinamento avanzato delle risorse in AEM](enhance-sort.md)
...
+ Risorse 3D {#three-d}
   + [Note sulla versione di AEM 3D](../release-notes/aem3d-release-notes.md)
