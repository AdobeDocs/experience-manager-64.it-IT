...
1. Dalla pagina **[!UICONTROL Crea rapporto]**, scegli il rapporto che desideri creare e fai clic su **[!UICONTROL Avanti]**.
   ...
   >[!NOTE]
   >
   >Per impostazione predefinita, i frammenti di contenuto e le condivisioni di collegamento sono inclusi nel rapporto [!UICONTROL Scaricato] della risorsa. Seleziona l’opzione appropriata per creare un rapporto di condivisioni di collegamenti o per escludere frammenti di contenuto dal rapporto di download.

   >[!NOTE]
   >
   >Il rapporto [!UICONTROL Scarica] visualizza i dettagli solo delle risorse selezionate singolarmente e scaricate o scaricate utilizzando la funzione Azione rapida. Tuttavia, non include i dettagli delle risorse che si trovavano all’interno di una cartella scaricata.
