...
1. Dalla pagina **[!UICONTROL Crea rapporto]**, scegliere il rapporto che si desidera creare e fare clic su **[!UICONTROL Avanti]**.
   ...
   >[!NOTE]
   >
   >Per impostazione predefinita, i frammenti di contenuto e le condivisioni di collegamenti sono inclusi nel rapporto [!UICONTROL Scaricato] della risorsa. Selezionate l&#39;opzione appropriata per creare un rapporto delle condivisioni di collegamenti o per escludere i frammenti di contenuto dal rapporto di download.

   >[!NOTE]
   >
   >Il rapporto [!UICONTROL Download] visualizza i dettagli solo delle risorse selezionate singolarmente e scaricate o scaricate mediante la funzione Azione rapida. Tuttavia, non include i dettagli delle risorse che si trovavano all’interno di una cartella scaricata.
