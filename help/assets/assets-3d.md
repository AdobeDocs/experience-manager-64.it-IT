...
# Operazioni con AEM risorse 3D {#working-with-d-assets}

>[!IMPORTANT]
>
>AEM 3D in AEM 6.4 non è più supportato.  Adobe consiglia di utilizzare la funzionalità delle risorse 3D in [AEM come Cloud Service](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/assets/dynamicmedia/assets-3d.html) o [AEM 6.5.3 o superiore.](https://docs.adobe.com/content/help/en/experience-manager-65/assets/dynamic/assets-3d.html)
...
## I modelli e le fasi di AEM 3D {#about-models-and-stages-in-aem-d}
...
Una tipica risorsa 3D ha un file modello principale e nessuno o più file di riferimento. I file a cui si fa riferimento includono ad esempio mappe di texture o immagini **IBL (Image-Based Lighting)**.
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td>Videocamere</td> 
   <td><p>Selezionare per <strong>stadi 3D</strong>.</p> <p>Deselezionate questa opzione per i modelli 3D.</p> </td> 
  </tr> 
  <tr> 
   <td>Luci</td> 
   <td><p>Selezionare per <strong>stadi 3D</strong>.</p> <p>Deselezionare per <strong>modelli 3D</strong>.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>Sono supportate entrambe le opzioni. Se è selezionata l'opzione Incorporato, AEM 3D estrae il supporto incorporato in una cartella adiacente con lo stesso nome del file modello al quale è aggiunto <code>.fbm</code>.</td> 
  </tr> 
  <tr> 
...
### Supporto per i file di mappa texture {#support-for-texture-map-files}
...
Vedere [Informazioni sull&#39;utilizzo delle fasi IBL](working-with-ibl-stages.md).
...
## Ombreggiatura materiale in un file modello 3D principale {#material-shading-in-a-primary-d-model-file}

Il file del modello nativo originale può contenere definizioni di materiale utilizzate con shader quali Blinn, Lambert o con shaders procedurali. Questi materiali potenzialmente complessi sono supportati solo quando eseguite il rendering utilizzando l&#39;applicazione nativa corrispondente (ad esempio Autodesk Maya).
