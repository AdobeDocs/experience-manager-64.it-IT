...
1. **Aggiunta di punti attivi a un banner immagine** - Aggiungi uno o più punti attivi a un banner immagine e associali ciascuno di essi a un’azione come un collegamento ipertestuale, una visualizzazione rapida o un frammento esperienza. Dopo aver aggiunto gli hotspot, finirai questa attività pubblicando l&#39;immagine interattiva.
   ...
   * Vedi [Pubblicazione delle risorse](publishing-dynamicmedia-assets.md) per informazioni dettagliate su come pubblicare le risorse immagine interattive.

1. **Aggiunta di un’immagine interattiva al sito web o al sito web in AEM**

   * Se utilizzi AEM Sites, eCommerce AEM o entrambi, puoi aggiungere l’immagine interattiva direttamente a una pagina web in AEM trascinando il componente File multimediali interattivi sulla pagina. Vedi [Aggiunta di risorse Dynamic Media alle pagine](adding-dynamic-media-assets-to-pages.md).
   * Se utilizzi AEM Assets e Dynamic Media standalone, devi copiare il codice da incorporare sul tuo sito web e quindi integrarlo con la visualizzazione rapida esistente. Vedi [Integrazione di un’immagine interattiva con il sito web](#integrating-an-interactive-image-with-your-website).
   * Se utilizzi un WCM di terze parti (Web Content Manager), devi integrare il nuovo video interattivo con l’implementazione Quickview esistente utilizzata sul sito web. Vedi [Integrazione di un’immagine interattiva con una Quickview esistente](#integrating-an-interactive-image-with-an-existing-quickview).
...
>* L&#39;implementazione di AEM *not* utilizza un framework di integrazione eCommerce per estrarre i dati dei prodotti in AEM da qualsiasi soluzione eCommerce come IBM Websphere Commerce, Elastic Path, hybris o Intershop. Vedi [Concetti di eCommerce in AEM Assets](/help/sites-administering/concepts.md).
>
...
* Per visualizzare tutte le richieste HTTP in uscita in Google Chrome, premi F12 per aprire il **[!UICONTROL Strumenti per gli sviluppatori]** , quindi fai clic sul **[!UICONTROL Rete]** scheda .

   Su un Mac, premere **[!UICONTROL Comando+Opzione+I]** per aprire **[!UICONTROL Strumenti per gli sviluppatori]** quindi fare clic sulla scheda Rete.

* In Firefox, è possibile attivare il plug-in Firebug premendo F12 e utilizzando la relativa scheda Net, oppure è possibile utilizzare il **[!UICONTROL Ispettore]** strumento **[!UICONTROL Rete]** scheda .

   Su un Mac, premere **[!UICONTROL Comando+Opzione+I]** per aprire **[!UICONTROL Strumenti per gli sviluppatori]** , quindi fai clic sul **[!UICONTROL Ispettore]** scheda .
     ...
     <tbody> 
      <tr> 
       ...
       <td><p>Gli URL registrati di Quickview includono quanto segue:</p> 
        ...
        </ul> <p>L’unica parte variabile nell’URL è il valore del parametro della stringa query productId= ed è chiaramente un valore SKU. Pertanto, i nostri hotspot richiedono solo campi SKU popolati con valori come <strong><code>866558</code></strong>, <strong><code>1196184</code></strong>, <strong><code>1081492</code></strong>, <strong><code>1898294</code></strong>.</p> </td> 
      </tr> 
      <tr> 
...
La pagina web demo ha diverse miniature di prodotto, ognuna con un pulsante Quickview etichettato **[!UICONTROL Altro]**. Con lo strumento di debug del browser Web ancora attivato, fai clic su ogni pulsante e osserva gli URL registrati di Quickview. Dopo aver attivato tutti e quattro i prodotti Quickview disponibili sulla pagina, si dispone del seguente elenco di richieste Quickview effettuate al backend:
...
Puoi scegliere di utilizzare il predefinito visualizzatore di immagini interattive predefinito denominato **[!UICONTROL Banner_Shoppable]** che viene fornito con AEM Assets. Oppure puoi creare un predefinito visualizzatore personalizzato da usare con le immagini interattive.
...
1. In **[!UICONTROL Nuovo predefinito per visualizzatori]** digitare un nome per descrivere il predefinito visualizzatore banner interattivo.

   Titolo che verrà visualizzato nel **[!UICONTROL Predefinito visualizzatore]** pagina elenco dopo il salvataggio.
1. In **[!UICONTROL Tipo di contenuti multimediali]** menu a discesa, seleziona **[!UICONTROL Immagine interattiva]**.
1. Tocca **Crea**.
1. Sulla **[!UICONTROL Modifica predefinito visualizzatore]** , tocca **[!UICONTROL Aspetto]** scheda .
1. Effettua una delle operazioni seguenti:

   * Per caricare l’immagine del tuo punto attivo che desideri utilizzare sulle immagini, tocca **[!UICONTROL Selettore risorse]** icona. In **[!UICONTROL Seleziona contenuto]** , individua l’immagine del punto attivo da utilizzare, selezionala e tocca il **[!UICONTROL Contrassegno]** nell&#39;angolo in alto a destra.
   * Per selezionare un’immagine punto attivo predefinita, tocca **[!UICONTROL Galleria Hotspot]** icona. Nella palette della galleria punto attivo, toccare l&#39;immagine del punto attivo che si desidera utilizzare.
...
1. Nell’angolo in alto a destra della pagina, tocca **[!UICONTROL Salva]**.
   ...
   Vedi [Pubblicazione Dei Predefiniti Visualizzatore Aggiunti](managing-viewer-presets.md#publishing-viewer-presets).
...
Puoi aggiungere punti attivi a un banner immagine utilizzando l’editor nella sezione **[!UICONTROL Gestione dei punti attivi]** pagina.
...
Al termine della creazione dell’immagine interattiva, puoi utilizzare **[!UICONTROL Anteprima]** per visualizzare una rappresentazione dell’immagine interattiva che verrà visualizzata ai clienti.
...
>
>Vedi anche [Banner a carosello](carousel-banners.md).
...
1. Effettua una delle operazioni seguenti:
   ...
   * Tocca l’immagine per aprirla nel **[!UICONTROL Vista dettagli]** pagina. Sulla barra degli strumenti, tocca **[!UICONTROL Modifica]**.

1. Nell’angolo in alto a sinistra della pagina, tocca **[!UICONTROL Aggiungi punto attivo]** (icona a forma di dito) per aprire **[!UICONTROL Gestione dei punti attivi]** pagina.
1. Nell’angolo in alto a sinistra della pagina, tocca **[!UICONTROL Punto attivo]**.
1. a) Vicino all&#39;angolo superiore sinistro del **Gestione dei punti attivi** pagina, tocca **[!UICONTROL Punto attivo]**.
...
c. Aggiungi eventuali hotspot aggiuntivi ripetendo i passaggi a e b. d. (Facoltativo) Per eliminare un punto attivo, selezionalo sull’immagine, quindi tocca **[!UICONTROL Elimina]** (icona del bidone della spazzatura) sotto il **[!UICONTROL Punti attivi]** intestazione.

1. In **[!UICONTROL Nome]** campo di testo, digitare il nome del punto attivo. Questo nome viene visualizzato anche nel **[!UICONTROL Punto attivo selezionato]** elenco a discesa.
1. Effettua una delle operazioni seguenti:

   * Tocca **[!UICONTROL Quickview]**.

      * Se sei un cliente AEM Sites o eCommerce, tocca il **[!UICONTROL Selettore prodotto]** icona (lente di ingrandimento) per aprire **[!UICONTROL Seleziona prodotto]** pagina. Tocca il prodotto da utilizzare, quindi tocca **[!UICONTROL Seleziona]** nell’angolo in alto a destra della pagina per tornare al **[!UICONTROL Gestione dei punti attivi]** pagina.
      * Se sei *not* un cliente AEM Sites o eCommerce

         * Vedi [Identificazione delle variabili dei punti attivi](#optional-identifying-hotspot-variables); dovrai definire queste variabili.
   ...
   * Tocca **Collegamento ipertestuale**.
      ...
      * Se sei un cliente AEM Sites, tocca il **[!UICONTROL Selettore sito]** icona (cartella) per passare a un URL. Il metodo di collegamento basato su URL non è possibile se il contenuto interattivo include collegamenti con URL relativi, in particolare con le pagine AEM Sites.
   ...
   * Tocca **Frammento esperienza**.
      ...
      * Se sei un cliente AEM Sites, tocca il **[!UICONTROL Ricerca]** icona (lente di ingrandimento) per aprire **[!UICONTROL Frammento esperienza]** pagina. Tocca il frammento esperienza da utilizzare, quindi tocca **[!UICONTROL Seleziona]** nell’angolo in alto a destra della pagina per tornare alla pagina Gestione punti attivi.
...
1. Tocca **[!UICONTROL Salva]** per salvare il lavoro e tornare al **[!UICONTROL Sfoglia]** pagina.
1. Pubblica l’immagine interattiva. La pubblicazione consente di distribuire il banner tramite il cloud e genera anche codice di incorporamento se è necessario eseguire l’integrazione con un sito web di terze parti.
   ...
   Vedi [Pubblicazione delle risorse](managing-assets-touch-ui.md#publishing-assets).

   Dopo aver aggiunto gli hotspot e pubblicato l&#39;immagine interattiva, ora puoi aggiungerla al tuo sito web esistente.

   Vedi [Integrazione di un’immagine interattiva con il sito web](#integrating-an-interactive-image-with-your-website).
...
1. Nell’angolo in alto a sinistra della pagina Anteprima, nella sezione **[!UICONTROL Contenuto]** elenco a discesa, tocca **[!UICONTROL Visualizzatori]**.
1. In **[!UICONTROL Visualizzatori]** elenco, tocca **[!UICONTROL Banner_Shoppable]** o il nome del predefinito per visualizzatori di immagini interattivi che hai creato.
...
Se sei un cliente di AEM Sites, puoi aggiungere l’immagine interattiva trascinando il componente File multimediali interattivi sulla pagina. Vedi [Aggiunta di risorse Dynamic Media alle pagine.](adding-dynamic-media-assets-to-pages.md)
...
Vedi [Identificazione delle variabili dei punti attivi](#optional-identifying-hotspot-variables).
