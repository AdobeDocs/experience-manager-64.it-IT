...
1. Avvia una richiesta di supporto tecnico per passare a HTTP2. Consulta [Accesso al portale di assistenza clienti](https://helpx.adobe.com/experience-manager/kb/accessing-aem-support-portal.html).
