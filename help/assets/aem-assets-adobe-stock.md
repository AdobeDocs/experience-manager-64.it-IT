---
title: Utilizzare le risorse Adobe Stock nei AEM Assets
...
L’integrazione richiede un piano [Adobe Stock](https://stockenterprise.adobe.com/) aziendale e AEM 6.4 con almeno Service Pack 2 implementato. Per informazioni dettagliate sul service pack di AEM 6.4, consultate queste note [sulla](/help/release-notes/sp-release-notes.md)versione.
...
>[!NOTE]
>
>Se sono presenti più configurazioni di Adobe Stock, seleziona la configurazione desiderata nel pannello Preferenze utente (**[!UICONTROL AEM]** > Icona **** utente > Preferenze **** utente > Configurazione **** Stock).

## Utilizzo e gestione di risorse Adobe Stock in AEM {#use-and-manage-adobe-stock-assets-in-aem}
...
![Finestra di dialogo per ottenere la licenza e salvare le risorse Adobe Stock in AEM Assets](assets/aem-stock_licenseandsave.jpg)

*Figura: Finestra di dialogo per ottenere la licenza e salvare le risorse Adobe Stock in AEM Assets*
