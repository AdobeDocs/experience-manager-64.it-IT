---
title: Gestione dei predefiniti per visualizzatori per contenuti multimediali dinamici
seo-title: Gestione dei predefiniti per visualizzatori per contenuti multimediali dinamici
...
| **File multimediali diversi** | Visualizza diversi tipi di supporti in un visualizzatore. Potete includere set 360 gradi, set di immagini, immagini e video. |
...
|  | Importante: Questo visualizzatore è disponibile solo in modalità Contenuti multimediali dinamici - Scene7. |
...
## Aumento del numero di predefiniti per visualizzatori per contenuti multimediali dinamici visualizzati {#increasing-the-number-of-viewer-presets-that-display}
...
**Per aumentare il numero di predefiniti per visualizzatori per contenuti multimediali dinamici visualizzati**:
...
**Per creare un nuovo predefinito** per visualizzatori per contenuti multimediali dinamici:
...
1. Nel menu a discesa **[!UICONTROL Rich Media Type]** (Tipo **[!UICONTROL contenuto multimediale avanzato), selezionate il tipo di predefinito per visualizzatori da creare, quindi toccate]** Creanell’angolo superiore destro della pagina.
...
1. Effettua una delle operazioni seguenti:
   ...
   * In the **[!UICONTROL Selected Type]** pull-down menu, select a component whose visual design you want to customize. In alternativa, potete toccare qualsiasi elemento visivo nel visualizzatore per selezionarlo per la configurazione.
      ...
      Le proprietà di stile CSS per ciascun tipo di predefinito per visualizzatori sono descritte nell’argomento della guida &quot;Personalizzazione *&lt;nome_visualizzatore>* visualizzatore&quot; nella Guida di riferimento dei [visualizzatori](https://marketing.adobe.com/resources/help/en_US/s7/viewers_ref/).

      Ad esempio, se state creando un predefinito per visualizzatori di tipo `Mixed_Media`, consultate [Personalizzazione del visualizzatore](https://marketing.adobe.com/resources/help/en_US/s7/viewers_ref/c_html5_mixedmedia_viewer_customizingviewer.html) di file multimediali diversi per un elenco e una descrizione di ciascuna proprietà.
...
## Attivazione o disattivazione dei predefiniti per visualizzatori per contenuti multimediali dinamici {#activating-or-deactivating-viewer-presets}
...
**Per attivare o disattivare i predefiniti** per visualizzatori per contenuti multimediali dinamici:
...
Attivando (o *attivando*) lo stato di un predefinito per visualizzatori significa che è visibile nel componente Contenuti multimediali dinamici, nel componente Contenuti multimediali interattivi e ogni volta che visualizzate una risorsa.
...
**Per ordinare i predefiniti** per visualizzatori per contenuti multimediali dinamici:
...
**Per modificare i predefiniti** per visualizzatori per contenuti multimediali dinamici:
...
**Per applicare a una risorsa** un predefinito per visualizzatori per contenuti multimediali dinamici:
