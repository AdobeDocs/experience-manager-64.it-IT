...
Per illustrare queste inefficienze, Adobe ha verificato le prestazioni del sistema utilizzando WebDAV su OS X. Un file InDesign da 3,5 MB è stato aperto, modificato e le modifiche sono state salvate. Sono state formulate le seguenti osservazioni:
