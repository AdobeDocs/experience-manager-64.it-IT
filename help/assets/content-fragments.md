...
* [Markdown](content-fragments-markdown.md) : utilizzo della sintassi di marketing per il frammento

* [Utilizzo del contenuto](content-fragments-assoc-content.md)  associato - aggiunta del contenuto associato
...
>
>Per ulteriori informazioni, vedere anche [Informazioni sui frammenti di contenuto e i frammenti esperienza in AEM](https://helpx.adobe.com/experience-manager/kt/platform-repository/using/content-fragments-experience-fragments-article-understand.html).
...
>[!NOTE]
>
>AEM supporta anche la conversione del contenuto del frammento. Per ulteriori informazioni, vedere [Creazione di progetti di traduzione per i frammenti di contenuto](creating-translation-projects-for-content-fragments.md).
...
* Frammenti contenenti contenuto strutturato
   ...
   * Si basano su un [modello di frammento di contenuto](content-fragments-models.md) che preimposta una struttura per il frammento risultante.
...
* **Contenuto associato**
   ...
   * Per ulteriori informazioni, vedere [Contenuto associato](content-fragments-assoc-content.md).
...
* **Metadati frammento**
   ...
   * Utilizzare gli schemi di metadati [Risorse](metadata.md).
...
* **Varianti**
   ...
   * Può essere [Summarized](content-fragments-variations.md#summarizing-text) per troncare rapidamente il testo fino a una lunghezza predefinita.
