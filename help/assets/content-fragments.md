...
* [Gestione dei frammenti](content-fragments-managing.md) di contenuto: creazione dei frammenti di contenuto; quindi modifica, pubblicazione e riferimento

* [Modelli](content-fragments-models.md) di frammenti di contenuto - attivazione, creazione e definizione dei modelli

* [Variazioni - Creazione di contenuti](content-fragments-variations.md) di frammento - Creazione di contenuti di frammento e creazione di varianti del contenuto principale

* [Markdown](content-fragments-markdown.md) - uso della sintassi di marketing per il frammento

* [Utilizzo di contenuto](content-fragments-assoc-content.md) associato - aggiunta di contenuto associato
...
>[!NOTE]
>
>AEM supporta anche la conversione del contenuto del frammento. Per ulteriori informazioni, consulta [Creazione di progetti di traduzione per i frammenti](creating-translation-projects-for-content-fragments.md) di contenuto.
...
* Frammenti contenenti contenuto strutturato
   ...
   * Questi si basano su un modello [di frammento di](content-fragments-models.md)contenuto, che predefinito una struttura per il frammento risultante.
...
* **Inserire una risorsa** in un frammento (frammenti multimediali diversi)
   ...
   * Per ulteriori informazioni, vedere [Inserimento di risorse nel frammento](content-fragments-variations.md#inserting-assets-into-your-fragment) nell’Editor frammento.
...
* **Contenuto associato**
   ...
   * Per ulteriori informazioni, consulta Contenuto [](content-fragments-assoc-content.md) associato.
...
* **Risorse inserite in un frammento (frammenti di file multimediali diversi)**
   ...
   * È possibile aggiungere, eliminare o spostare solo all’interno di un frammento utilizzando il formato [RTF nell’editor](content-fragments-variations.md#inserting-assets-into-your-fragment)frammento.
...
* **Contenuto associato**
   ...
   * Le risorse sono [associate ai frammenti tramite raccolte](content-fragments-assoc-content.md); le raccolte associate consentono all&#39;autore di decidere quali risorse utilizzare al momento della creazione della pagina.
      ...
      * [Le raccolte](managing-collections-touch-ui.md) di risorse (DAM) sono la base per il contenuto associato dei frammenti.
   * Facoltativamente, è anche possibile aggiungere il frammento stesso a una raccolta per facilitare il tracciamento.


* **Metadati frammento**

   * Utilizzate gli schemi [di metadati delle](metadata.md)risorse.
...
* **Principale**
   ...
   * Master è accessibile nell&#39;editor frammento in **[Variazioni](content-fragments-variations.md)**.
...
* **Varianti**
   ...
   * Le varianti possono essere [sincronizzate](content-fragments-variations.md#synchronizing-with-master) con Master se il contenuto Master è stato aggiornato.
   * Può essere [sintetizzato](content-fragments-variations.md#summarizing-text) per troncare rapidamente il testo fino a una lunghezza predefinita.
   * Disponibile nella scheda [Variazioni](content-fragments-variations.md) dell&#39;Editor frammento.
...
* **Modello di contenuto**
   ...
   * Vengono [abilitati e quindi creati utilizzando Strumenti](content-fragments-models.md).
   * Obbligatorio per [creare un frammento](content-fragments-managing.md#creating-content-fragments)strutturato.
...
* **Modello frammento**
   ...
   * Obbligatorio per [creare un frammento](content-fragments-managing.md#creating-content-fragments)semplice.
