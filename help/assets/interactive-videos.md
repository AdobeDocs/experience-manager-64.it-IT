...
1. **Aggiunta di un video interattivo al sito web o al sito web, ad Experience Manager**
   ...
   Se utilizzi Experience Manager Sites o Experience Manager eCommerce o entrambi, puoi aggiungere il video interattivo direttamente a una pagina web in un Experience Manager trascinando il componente File multimediali interattivi sulla pagina. Consulta [Aggiunta di risorse Dynamic Media alle pagine](adding-dynamic-media-assets-to-pages.md).
...
Quando si applica l&#39;approccio di cui sopra al sito web Example, si dispone di una pagina web con diverse miniature di prodotto, ciascuna con un pulsante **[!UICONTROL SEE MORE]**:
...
1. Nella pagina **[!UICONTROL Crea video interattivo]** , effettua una delle seguenti operazioni:
   ...
   * Toccare il pulsante **[!UICONTROL Play]** per riprodurre il video. Quando un particolare prodotto, servizio o dettaglio da evidenziare viene visualizzato, tocca **[!UICONTROL Aggiungi segmento]** sulla barra degli strumenti. Ripetere l&#39;operazione fino a quando non si raggiunge la fine del video.
   ...
   * Toccare il pulsante **[!UICONTROL Play]** per riprodurre il video. Quando un particolare prodotto, servizio o dettaglio da evidenziare viene visualizzato, toccare **[!UICONTROL Pausa]**. Tocca **[!UICONTROL Aggiungi segmento]**.
...
1. (Facoltativo) Trascinare la barra sul **[!UICONTROL Cursore scala timeline]** a sinistra per ingrandire o a destra per ridurre. In questo modo puoi controllare quanti dettagli vengono visualizzati dei segmenti aggiunti.
   ...
   Nella schermata B precedente, il cursore **[!UICONTROL Scala timeline]** è stato trascinato dal valore predefinito di 5 secondi a 3 secondi. Tieni presente che i singoli timestamp **[!UICONTROL Scala timeline]** sono ora tutti impostati a intervalli di 3 secondi.
   ...
   <table> 
    <tbody> 
      ...
      <td><p>In Tipo azione, tocca <strong>Quickview</strong>.</p> <p>Se sei un cliente Experience Manager Sites ed e-commerce:</p> 
       ...
       <ul> 
       <li>Consulta <a href="/help/assets/carousel-banners.md#identifying-hotspot-and-image-map-variables">Identificazione delle variabili dei punti attivi</a>. Devi definire queste variabili. </li> 
...
Se sei un cliente di Experience Manager Sites, puoi aggiungere il video interattivo trascinando il componente File multimediali interattivi nella pagina. Consulta [Aggiunta di risorse Dynamic Media alle pagine](adding-dynamic-media-assets-to-pages.md).
...
Il sito Web demo sta attivando la finestra di dialogo Quickview utilizzando una semplice chiamata di funzione `loadQuickView()`. Questa funzione accetta un solo argomento, ovvero l’URL dei dati Quickview. L’ultimo passaggio consiste nell’integrare il video interattivo, ovvero aggiungere la seguente riga di codice al gestore `quickViewActivate`:
...
Vedere [Creazione di pop-up personalizzati utilizzando Quickview](custom-pop-ups.md).
