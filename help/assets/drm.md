...
1. Scegli **[!UICONTROL Riferimenti]** dal menu .
   ...
   Per le risorse scadute, nella barra Riferimenti viene visualizzato lo stato di scadenza **[!UICONTROL Risorsa scaduta]** nella parte superiore.

   ![chlimage_1-147](assets/chlimage_1-147.png)

   Se la risorsa è scaduta, nella barra Riferimenti viene visualizzato lo stato **[!UICONTROL Risorse secondarie scadute]**.
...
1. Fai clic sul logo [!DNL Experience Manager] per visualizzare il pannello di ricerca.

   ![chlimage_1-151](assets/chlimage_1-151.png)

1. Fai clic sull&#39;opzione **[!UICONTROL Stato scadenza]** per espanderla.
