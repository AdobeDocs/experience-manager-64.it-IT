...
1. Per cercare le risorse in base al loro stato, toccate o fate clic sull’icona **[!UICONTROL Cerca]** per visualizzare la barra di ricerca Omni.
...
>[!NOTE]
>
>La posizione */etc/dam/drm/license* utilizzata per memorizzare le licenze nelle versioni precedenti di AEM è obsoleta.
>
>Se create o modificate le pagine delle licenze o le rimuovete dalle versioni precedenti di AEM, Adobe consiglia di memorizzarle in */apps/settings/dam/drm/licenses* o */conf/&amp;ast;/settings/dam/drm/license*.
