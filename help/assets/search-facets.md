...
1. Effettua una delle operazioni seguenti:
   ...
   * Toccate l&#39;icona ![](assets/do-not-localize/aem_assets_add_icon.png) Aggiungi accanto al campo Opzioni per specificare il testo e il valore di visualizzazione per le opzioni che desiderate fornire nel pannello Filtri. Per aggiungere un’altra opzione, toccate o fate clic sull’icona ![](assets/do-not-localize/aem_assets_add_icon.png) Aggiungi e ripetete il passaggio.
