...
1. Tocca o fai clic su **[!UICONTROL Anteprima]** ![anteprima](assets/preview.png) per generare un’anteprima del pannello Filtri così come viene visualizzato dopo l’aggiunta del predicato.
...
1. Per chiudere l&#39;anteprima, tocca o fai clic su **[!UICONTROL Chiudi]** ![chiudi](assets/close.png) nell&#39;angolo superiore destro dell&#39;anteprima.
...
1. Effettua una delle operazioni seguenti:
   ...
   * Tocca ![Aggiungi icona](assets/do-not-localize/aem_assets_add_icon.png) accanto al campo Opzioni per specificare il testo e il valore da visualizzare per le opzioni che desideri fornire nel pannello Filtri . Per aggiungere un’altra opzione, tocca o fai clic su ![Aggiungi icona](assets/do-not-localize/aem_assets_add_icon.png) e ripeti il passaggio.
...
1. Tocca **[!UICONTROL Elimina]** ![elimina il profilo](assets/deleteoutline.png) nella barra degli strumenti.
