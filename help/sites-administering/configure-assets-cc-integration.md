...
>[!NOTE]
>
>Questa funzione è obsoleta in AEM Assets. Trova sostituzioni in [Best practice per l’integrazione di AEM e Creative Cloud](/help/assets/aem-cc-integration-best-practices.md). Se hai delle domande, [contattare l&#39;assistenza clienti Adobe](https://www.adobe.com/account/sign-in.supportportal.html).
...
1. Fai clic su **[!UICONTROL Crea]**. Un messaggio notifica la creazione dell&#39;applicazione.
   ...
   ![Notifica della corretta creazione dell’applicazione per l’integrazione di AEM Assets con Adobe Creative Cloud](assets/chlimage_1-289.png)
...
1. In **[!UICONTROL Crea configurazione]** , specifica un titolo e un nome per la nuova configurazione e fai clic su **[!UICONTROL Crea]**.
   ...
   ![Assegnare un nome a una nuova configurazione per integrare AEM Assets e Creative Cloud](assets/cloudservices_configure_mc.png)
...
1. Nella finestra di dialogo, fai clic su **[!UICONTROL Prova connessione]**.
   ...
   ![Verifica la connessione e imposta il profilo di replica predefinito per la tua organizzazione](assets/chlimage_1-294.png)
...
1. Seleziona la cartella e fai clic su **Condividi** ![assets_share](assets/assets_share.png).
