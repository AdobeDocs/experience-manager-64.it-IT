...
1. Utilizzate i componenti per creare il contenuto. Consultate [Aggiunta di funzioni di Search&amp;Promote a una pagina](/help/sites-authoring/search-and-promote.md)Web.
...
1. Fate clic sull’elemento Configurazione **[!UICONTROL Search&amp;Promote CQ]** Day.
1. Nel campo di testo URI **[!UICONTROL del server]** remoto, immettete l&#39;URL, quindi toccate **[!UICONTROL Salva]**.

## Configurazione della connessione ad Search&amp;Promote {#configuring-the-connection-to-search-promote}
...
1. Dall&#39;icona **[!UICONTROL Strumenti]** > **[!UICONTROL Distribuzione]**, selezionate **[!UICONTROL Cloud Services]**.
...
1. Nella pagina [!UICONTROL Cloud Services] , toccate il **[!UICONTROL collegamento Search&amp;Promote]** Adobe o l’icona **[!UICONTROL Search&amp;Promote]** .

1. Se è la prima volta che configurate  Search&amp;Promote, toccate **[!UICONTROL Configura ora]** per aprire il pannello [!UICONTROL Crea configurazione] .

   Per ulteriori informazioni su Search&amp;Promote, fare clic su **[!UICONTROL Ulteriori]** informazioni.
...
1. Immettete un **[!UICONTROL Titolo]** riconoscibile per gli autori delle pagine, quindi immettete un **[!UICONTROL Nome]** univoco, quindi toccate **[!UICONTROL Crea]**.
   ...
   Inoltre, la configurazione appena creata viene visualizzata sotto la voce **[!UICONTROL Configurazioni]** disponibili nel dashboard **** Cloud Services  Adobe Search&amp;Promote elenco.
...
1. Tap **[!UICONTROL Connect To Search&amp;Promote]**.
   ...
   Dopo la connessione, il testo del pulsante cambia in **[!UICONTROL Connetti nuovamente a Search&amp;Promote]**.
...
1. Passate alla console Web all&#39;indirizzo `http://localhost:4502/system/console/configMgr/com.day.cq.searchpromote.impl.SearchPromoteServiceImpl`
...
Per informazioni sull’utilizzo dei componenti, vedere [Aggiunta di funzionalità di Search&amp;Promote a una pagina](/help/sites-authoring/search-and-promote.md)Web.
...
1. Fate clic sulla scheda **[!UICONTROL Cloud Services]** .
...
1. Fate clic su **[!UICONTROL Aggiungi servizio]**, selezionate **[!UICONTROL Search&amp;Promote]** Adobe, quindi fate clic su **[!UICONTROL OK]**.
...
* Sfruttate la funzione [!UICONTROL Controllo] remoto del Search&amp;Promote per eseguire richieste on-demand o programmate del feed di prodotto.
