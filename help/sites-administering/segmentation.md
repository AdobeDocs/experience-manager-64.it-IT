...
>
>Pertanto, quando [crei un segmento](/help/sites-administering/segmentation.md#creating-a-new-segment), devi selezionare un tipo **di** dati ogni volta che sono noti i tipi di valori confrontati. Ad esempio:
>
...
1. Implementare una funzione che restituisce un valore. Ad esempio:
