...
seo-description: Scopri come creare e sincronizzare Live Copy.
...
1. Ti verrà chiesto di confermare i dettagli del rollout:
   ...
   * **Rollout sfondo**:
      ...
      Se sono coinvolte più pagine o sottopagine, puoi eseguire il rollout come attività in background.
...
* Aggiungi i paragrafi alla pagina.
...
1. Conferma l’azione **Sospendi** nella finestra di dialogo **Sospendi Live Copy **a:
...
Quando questa opzione è selezionata, viene visualizzata la finestra di dialogo . Se necessario, puoi selezionare una sincronizzazione e confermare l’azione.
...
1. Indica se desideri sincronizzare la pagina dopo aver ripristinato l’ereditarietà, quindi conferma l’azione **Riprendi** nella finestra di dialogo **Riprendi Live Copy **a.
...
1. Apri le proprietà della pagina Live Copy utilizzando l’opzione **Visualizza proprietà** della console **Sites** o l’icona **Informazioni pagina** nella barra degli strumenti della pagina.
