...
1. In **Sites** seleziona la pagina nella blueprint e apri la **[Riferimenti](/help/sites-authoring/basic-handling.md#references)** pannello (dalla barra degli strumenti).
...
1. Conferma la **Sospendi** nella finestra di dialogo **Sospendi Live Copy **:
...
1. Indica se desideri sincronizzare la pagina dopo aver ripristinato l’ereditarietà, quindi conferma la **Riprendi** nella finestra di dialogo **Riprendi Live Copy **.
