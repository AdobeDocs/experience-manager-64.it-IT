...
1. Crea una [nuova pagina](/help/sites-authoring/managing-pages.md) utilizzando il modello **Segmento** .
...
1. Puoi **modificare** la definizione del segmento per assegnargli un **fattore Titolo**, **Descrizione** e **[Incremento](/help/sites-administering/campaign-segmentation.md#boost-factor)**:
...
1. Premere **[Ctrl+Alt+C](/help/sites-authoring/keyboard-shortcuts.md)**per aprire il contesto**[](/help/sites-administering/client-context.md)**client, che mostra i dati raccolti. A scopo di test potete **modificare** alcuni valori o **caricare** un altro profilo per verificarne l’impatto.
...
I segmenti sono attualmente utilizzati in [Campagne](/help/sites-authoring/personalization.md). Vengono utilizzati per indirizzare il contenuto effettivo visualizzato da audience target specifiche. Per ulteriori informazioni, consulta [Informazioni sui segmenti](/help/sites-authoring/segmentation-overview.md) .
