...
1. Facendo clic sull&#39;icona Sfoglia si apre il selettore [Risorse](/help/assets/asset-selector.md#using-the-asset-selector).
...
1. Passate alla modalità [preview](/help/sites-authoring/editing-content.md#previewing-pages).
...
1. Viene visualizzata una finestra di dialogo. Toccate/fate clic **Done **al termine del processo.
...
>[!NOTE]
>
>L&#39;esempio seguente riguarda una promozione tenuta direttamente in una [campagna](/help/sites-authoring/personalization.md), utilizzata per i voucher.
>
...
>
>Per ulteriori informazioni, vedere [Promozioni e voucher](#promotions).
