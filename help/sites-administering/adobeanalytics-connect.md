...
# Connessione  Adobe Analytics e creazione di framework{#connecting-to-adobe-analytics-and-creating-frameworks}
...
1. Aprire la scheda **Cloud Services**.
...
Per ulteriori informazioni, vedere [Seeing Page Analytics Data](/help/sites-authoring/pa-using.md).
