...
2. Scorri fino ad **Adobe Analytics** e fai clic su **[+]** accanto a Configurazioni **** disponibili.
3. Fai clic sul collegamento **[+]** accanto alla configurazione di Adobe Analytics.
...
* **Server per tracking**
   ...
   * contiene l&#39;URL utilizzato per inviare le chiamate ad Adobe Analytics
      ...
      * cname - impostazione predefinita per l&#39;account Adobe Analytics *Nome società *
