...
Prima di continuare, accertati che le tue credenziali ti consentano di accedere ad Adobe  Analytics utilizzando uno dei seguenti metodi:
...
2. Scorrete fino ad **Adobe  Analytics** e fate clic su **[+]** accanto a Configurazioni **** disponibili.
...
* **Server per tracking**
   ...
   * contiene l’URL utilizzato per inviare chiamate Adobe  Analytics
      ...
      * cname - impostazione predefinita dell&#39;account Adobe  Analytics *Nome società *
...
1. Aprite la scheda Servizi **** cloud.
...
Per ulteriori informazioni, consulta [Vedere pagina  dati](/help/sites-authoring/pa-using.md) Analytics.
