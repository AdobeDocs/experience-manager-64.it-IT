...
La sezione [Concetti](/help/sites-administering/concepts.md) copre il framework in modo più dettagliato, ma quanto segue fornisce una visualizzazione ad alto livello del framework:
