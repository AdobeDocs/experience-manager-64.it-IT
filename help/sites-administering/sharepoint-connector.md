...
Il connettore di SharePoint è disponibile per il download da [packageshare](https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq630/featurepack/cq-6.3.0-featurepack-17673).
...
AEM Package Share viene utilizzato per distribuire funzionalità, esempi e correzioni di prodotti. Per informazioni dettagliate, consultate la [documentazione di Package Share](/help/sites-administering/package-manager.md#package-share).
...
1. Selezionate Bypass the whitelist.

1. Aggiungi &#39;**com.day.cq.dam.cq-dam-jcr-connector**&#39; nei bundle whitelist predefiniti
...
1. Fornire l&#39;ID utente (il nome utente che ha accesso a SharePoint)
1. Immettere la password corrispondente
...
1. Fare clic su &quot;Administrators&quot;
1. Digitare l&#39;ID utente creato sopra nella casella di testo prima del pulsante **Sfoglia**
