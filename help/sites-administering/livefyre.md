...
description: Scoprite come integrare le funzionalità di cura leader di settore di Livefyre con l'istanza AEM 6.4, consentendo di pubblicare in pochi minuti contenuti generati dagli utenti dai social network al sito.
...
Scoprite come integrare le funzionalità di cura leader di settore di Livefyre con l&#39;istanza AEM 6.4, consentendo di pubblicare in pochi minuti contenuti generati dagli utenti dai social network al sito.
...
1. Da Gestione pacchetti, installate il pacchetto scaricato. Per istruzioni sull&#39;utilizzo di distribuzione software e pacchetti in AEM, vedere [Come lavorare con i pacchetti](/help/sites-administering/package-manager.md).
