...
>[!NOTE]
>
>Dopo un aggiornamento a 6.4, si consiglia di spostare il file da /etc. Per ulteriori informazioni, vedere [Ristrutturazione del repository comune in AEM 6.4](/help/sites-deploying/all-repository-restructuring-in-aem-6-4.md#translation-rules).
...
Nell&#39;editor, è possibile selezionare o deselezionare **I`s Deep`** nella scheda **Filtri**.
