...
>[!NOTE]
>
>Dopo un aggiornamento alla versione 6.4, si consiglia di spostare il file da /etc. Vedi [Ristrutturazione dell’archivio comune in AEM 6.4](/help/sites-deploying/all-repository-restructuring-in-aem-6-4.md#translation-rules) per ulteriori dettagli.
...
Nell’editor, puoi selezionare/deselezionare **I`s Deep`** in **Filtri** scheda .
