...
È possibile accedere al server ( ) senza il server proxy, ma se si accede tramite , il server proxy registra la comunicazione. Aprite un browser e accedete a una pagina creata con il modello precedente. Successivamente, consultare il file di registro.
