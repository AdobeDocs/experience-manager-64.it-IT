...
* **Nome**
UserIDShort per l&#39;account, utilizzato per accedere a CRX.

* **Nome**
entità: nome di testo completo per l’account.

* **Password**
necessaria per accedere a CRX con questo account.
...
**Appartenenza** al gruppo: visualizza tutti i gruppi a cui appartiene l’account. La colonna Ereditata indica l&#39;appartenenza ereditata a seguito dell&#39;appartenenza di un altro gruppo.

Facendo clic su un ID gruppo (se disponibile) si aprirà l&#39; [Amministrazione gruppo](#group-administration) per quel gruppo.

**** ImpersonatoriLa funzione Impersona permette a un utente di lavorare per conto di un altro utente.
...
* **Nome**
GroupIDShort per l’account del gruppo.

* **Nome**
entità: nome di testo completo per l’account del gruppo.

* È possibile aggiungere nuove proprietà definendo un nome, un tipo e un valore. Fate clic su Salva (simbolo di spunta verde) per ciascuna nuova proprietà.
* ****
MembriPotete aggiungere utenti o altri gruppi come membri di questo gruppo.

**Appartenenza** al gruppo: visualizza tutti i gruppi a cui appartiene l&#39;account del gruppo corrente. La colonna Ereditata indica l&#39;appartenenza ereditata a seguito dell&#39;appartenenza di un altro gruppo.
...
* **Criteri di controllo degli accessi locali:**
criteri di controllo degli accessi applicati. Potete quindi aggiornarli, ordinarli o rimuoverli.

   Un criterio locale ignora tutti i criteri ereditati dall&#39;elemento padre.

* **Criteri**
di controllo degli accessi efficaciQuesti sono i criteri di controllo degli accessi che sono ora in vigore per qualsiasi richiesta di accesso. Esse mostrano i criteri aggregati derivati sia dai criteri locali che da quelli ereditati dall&#39;elemento padre.

### Selezione criteri {#policy-selection}

È possibile selezionare i criteri per:

* **Percorso correnteCome nell’esempio precedente, selezionare una risorsa all’interno della directory archivio.**
Verranno visualizzati i criteri per questo &quot;percorso corrente&quot;.

* **Repository**
Consente di selezionare il controllo di accesso a livello di repository. Ad esempio, quando si imposta la variabile 
`jcr:namespaceManagement` privilegio, che è pertinente solo per il repository, non un nodo.

* ****
PrincipalEntità registrata nella directory archivio.
