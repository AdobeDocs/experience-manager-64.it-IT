...
>[!NOTE]
>
>Tutto il contenuto della campagna deve essere creato in una pagina `master` di tipo `cq/personalization/components/ambitpage`. Ad esempio, se pianificate una struttura di campagna è simile a:
>
