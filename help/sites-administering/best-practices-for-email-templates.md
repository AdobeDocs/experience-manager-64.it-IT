...
>[!NOTE]
>
>Tutto il contenuto della campagna deve essere creato sotto una `master` pagina di tipo `cq/personalization/components/ambitpage`. Ad esempio, se pianificate una struttura di campagna è simile a:
>
>* `/content/campaigns/teasers/en/campaign-promotion-global`
>
>
Accertarsi che si trovi sotto una pagina master:
>
