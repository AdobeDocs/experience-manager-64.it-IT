...
![In CRXDE, aggiungi un singolo carattere da rendere disponibile nella ](assets/chlimage_1-412.png "barra degli strumenti dell’editor Rich TextIn CRXDE, aggiungi un singolo carattere da rendere disponibile nella barra degli strumenti dell’editor Rich Text")
...
1. Salva le modifiche.
   ...
         *In CRXDE, definisci un intervallo di caratteri da rendere disponibili in RTE*
...
1. Sul nodo `undo` crea la proprietà:
   ...
   * **Nome** `maxUndoSteps`
   * **Tipo** `Long`
   * **** Valuta il numero di passaggi di annullamento da salvare nella cronologia.
...
1. Crea una nuova proprietà sul nodo `../items/text` nella definizione della finestra di dialogo del componente:
   ...
   * **Nome** `height`
   * **Tipo** `Long`
   * **** Valutare l&#39;altezza dell&#39;area di lavoro di modifica in pixel
