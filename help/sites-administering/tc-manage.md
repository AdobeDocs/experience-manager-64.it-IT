...
| Inviato | I file nel processo di traduzione hanno questo stato quando sono stati correttamente inviati al servizio di traduzione. Questo stato può verificarsi dopo che è stato emesso il comando Ambito richiesta o il comando Avvia. |
