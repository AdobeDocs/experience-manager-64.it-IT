...
Per salvare i dati dal servizio MD5 del sito jsontest.com, utilizzate la procedura in [Creazione di un archivio ContextHub](/help/sites-administering/contexthub-config.md#creating-a-contexthub-store) utilizzando le seguenti proprietà:
