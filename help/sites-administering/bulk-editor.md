...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>Indica il percorso principale ricercato dall'editor in blocco.<br /> Ad esempio, <code>/content/geometrixx/en</code>. L’editor in blocco esegue la ricerca su tutti i nodi secondari.</td> 
  </tr> 
  <tr> 
