...
Il pacchetto Livefyre Adobe Experience Manager è disponibile per AEM 6.1, 6.2SP1, 6.3, 6.4 e 6.4 SP1. AEM 5.x e 6.0 non sono supportati. Per istruzioni dettagliate, vedi [Integrazione con Livefyre](/help/sites-administering/livefyre.md).

Per vedere quali app Livefyre sono supportate, vedi [Matrice di supporto AEM per le app Livefyre](/help/sites-administering/livefyre.md#aem-support-matrix-for-livefyre-apps).
...
1. [Guida introduttiva](/help/sites-administering/livefyre.md#getting-started)
1. [Configurare AEM per l’utilizzo di Livefyre](/help/sites-administering/livefyre.md#configure-aem-to-use-livefyre-create-a-configuration-folder)
1. [Importazione di contenuti generati dagli utenti generati dagli utenti generati dagli eventi generati da Livefyre in AEM Assets](/help/sites-administering/livefyre.md#use-livefyre-with-aem-assets)
